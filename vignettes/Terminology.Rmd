...
the common factor. The common factor model is also referred to as the
...
which, in turn, serves as a "statistical proxy" for a concept under study. 
...
is acutally inadequate for the composite model since in a composite model
...
The measurement model is a statistical model relating indicators to constructs
(the statistical representiation of a concept). If the concept to study is modeled
as a common factor two measurement models exist:
