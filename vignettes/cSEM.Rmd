...
Structural equation modeling (SEM) has been used for over decades
across a various research fields such as (among others) psychology, 
...
to commonly used open-source and commerical software packages offering similar content. This 
introduction explains these principles to contrast them against the principles of existing software packages
