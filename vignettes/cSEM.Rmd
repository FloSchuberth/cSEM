...
Hence, users are strongly encourgaed to regularily consult the tow glossaries 
listed below to avoid potential misunderstandings:

1. The [terminology glossary](#terminology) contains each term that we 
...
1. The [mathematical notation glossary](#notation) contains each mathematical 
...
This introduction explains these principles to contrast them against the principles
of existing software packages and to point readers to further reading. 
Lastly, to use **cSEM** effectively, 
...
approaches for the theoretcal concepts exist. We refer to the first as [the latent variable model](#lvmodel) and to 
