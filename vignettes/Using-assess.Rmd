...
[Notation glossary][Notation] and the
[Termionology glossary][Terminology].
...
### Formulae
Using the results and notation derived and defined in the [Notation glossary][Notation],
...
which provides the foundation for the measurement model postulated 
in the [Notation glossary][Notation]. 
Based on the true score framework and using the terminology and notation of
the [Notation][Notation] and [Termniology][Terminology] glossary, reliability is defined as:

1. The amount of proxy true score variance, $Var(\bar\eta)$, relative to the 
   the proxy/score variance, $Var(\hat\eta)$.
2. This is identical to the squared correlation between the construct/common 
   factor and its proxy: $\rho_{\eta, \hat\eta}^2 = Cor(\eta, \hat\eta)^2$.
