...
:  Further arguments passed to functions called by `assess()`.
   See [args_assess_dotdotdot](https://m-e-rademaker.github.io/cSEM/reference/args_assess_dotdotdot.html) 
...
[Notation glossary](https://m-e-rademaker.github.io/cSEM/articles/Notation.html) and the
[Termionology glossary](https://m-e-rademaker.github.io/cSEM/articles/Termionlogy.html).
...
### Formula
Using the results and notation derived and defined in the [Notation glossary](https://m-e-rademaker.github.io/cSEM/articles/Notation.html),
