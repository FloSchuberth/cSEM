...
The interpretation of the estimators is the same as in the case of GSCA<sub>m</sub>. Comparing these values with those calculated in [Example1](#example1), the bias in estimators when using GSCA becomes obvious. 
