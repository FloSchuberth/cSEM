...
Var(\bar\varepsilon) &= E(\bar\varepsilon^2) = \sum w_k^2Var(\varepsilon_k) + 2\sum_{k < l} w_k w_l \delta_{kl} = \left(\sum w_k\varepsilon_k \right)^2 = (\bm{w}'\bm{\varepsilon})^2 \\
...
&=Var(\bar\eta) + Var(\bar\varepsilon) = (\bm{w}'\bm{\lambda})^2 + (\bm{w}'\bm{\varepsilon})^2 = \bm{w}'\bm{\Sigma}\bm{w} \\
