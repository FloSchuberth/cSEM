...
Postestimation functions are generic functions
to be applied to an object resulting from a call to `csem()`, `cca()` or `foreman()`. 
Depending on the class of the resulting object (e.g. `cSEMResults` or `cSEMSummary`)
