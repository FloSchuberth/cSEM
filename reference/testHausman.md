...
#>  eta1                      -0.3000      0.0998   -3.0045    0.0027
#>  eta2                       0.4999      0.0947    5.2800    0.0000
#>  eta6                       0.2501      0.1206    2.0733    0.0381
#>  Resid_eta6                 0.9784      0.2967    3.2980    0.0010
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0558    8.9506    0.0000
#>  eta4                       0.2501      0.0527    4.7410    0.0000
#>  eta5                       0.5001      0.0976    5.1226    0.0000
#>  Resid_eta5                -0.0056      0.1263   -0.0442    0.9647
#> ________________________________________________________________________________
```
