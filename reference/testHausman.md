...
#>  eta1                      -0.3000      0.0979   -3.0648    0.0022
#>  eta2                       0.4999      0.0865    5.7777    0.0000
#>  eta6                       0.2501      0.1097    2.2796    0.0226
#>  Resid_eta6                 0.9784      0.2578    3.7947    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0464   10.7646    0.0000
#>  eta4                       0.2501      0.0559    4.4719    0.0000
#>  eta5                       0.5001      0.1048    4.7701    0.0000
#>  Resid_eta5                -0.0056      0.1328   -0.0421    0.9664
#> ________________________________________________________________________________
```
