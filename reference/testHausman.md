...
#>  eta1                      -0.3000      0.1132   -2.6503    0.0080
#>  eta2                       0.4999      0.0992    5.0401    0.0000
#>  eta6                       0.2501      0.1172    2.1337    0.0329
#>  Resid_eta6                 0.9784      0.2607    3.7538    0.0002
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0569    8.7820    0.0000
#>  eta4                       0.2501      0.0554    4.5106    0.0000
#>  eta5                       0.5001      0.0996    5.0218    0.0000
#>  Resid_eta5                -0.0056      0.1210   -0.0462    0.9632
#> ________________________________________________________________________________
```
