...
#>  eta1                      -0.3000      0.0985   -3.0462    0.0023
#>  eta2                       0.4999      0.0744    6.7217    0.0000
#>  eta6                       0.2501      0.1153    2.1696    0.0300
#>  Resid_eta6                 0.9784      0.2392    4.0912    0.0000
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0600    8.3287    0.0000
#>  eta4                       0.2501      0.0577    4.3335    0.0000
#>  eta5                       0.5001      0.0984    5.0848    0.0000
#>  Resid_eta5                -0.0056      0.1264   -0.0442    0.9647
#> ________________________________________________________________________________
```
