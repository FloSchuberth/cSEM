...
#>  eta1                      -0.3000      0.1178   -2.5469    0.0109
#>  eta2                       0.4999      0.0939    5.3244    0.0000
#>  eta6                       0.2501      0.1392    1.7965    0.0724
#>  Resid_eta6                 0.9784      0.2789    3.5085    0.0005
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0554    9.0173    0.0000
#>  eta4                       0.2501      0.0536    4.6617    0.0000
#>  eta5                       0.5001      0.0984    5.0802    0.0000
#>  Resid_eta5                -0.0056      0.1446   -0.0386    0.9692
#> ________________________________________________________________________________
```
