...
#>  eta1                      -0.3000      0.1438   -2.0857    0.0370
#>  eta2                       0.4999      0.1026    4.8705    0.0000
#>  eta6                       0.2501      0.1511    1.6555    0.0978
#>  Resid_eta6                 0.9784      0.2551    3.8361    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0521    9.5936    0.0000
#>  eta4                       0.2501      0.0580    4.3147    0.0000
#>  eta5                       0.5001      0.1085    4.6088    0.0000
#>  Resid_eta5                -0.0056      0.1422   -0.0393    0.9687
#> ________________________________________________________________________________
```
