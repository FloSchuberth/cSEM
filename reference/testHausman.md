...
#>  eta1                      -0.3000      0.1219   -2.4613    0.0138
#>  eta2                       0.4999      0.0875    5.7151    0.0000
#>  eta6                       0.2501      0.1444    1.7320    0.0833
#>  Resid_eta6                 0.9784      0.2648    3.6947    0.0002
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0529    9.4405    0.0000
#>  eta4                       0.2501      0.0612    4.0875    0.0000
#>  eta5                       0.5001      0.1103    4.5353    0.0000
#>  Resid_eta5                -0.0056      0.1383   -0.0404    0.9678
#> ________________________________________________________________________________
```
