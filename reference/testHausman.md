...
#>  eta1                      -0.3000      0.1020   -2.9415    0.0033
#>  eta2                       0.4999      0.1000    4.9983    0.0000
#>  eta6                       0.2501      0.1088    2.2977    0.0216
#>  Resid_eta6                 0.9784      0.2473    3.9565    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0570    8.7757    0.0000
#>  eta4                       0.2501      0.0608    4.1109    0.0000
#>  eta5                       0.5001      0.1047    4.7764    0.0000
#>  Resid_eta5                -0.0056      0.1340   -0.0417    0.9668
#> ________________________________________________________________________________
```
