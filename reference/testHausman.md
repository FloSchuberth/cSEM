...
#>  eta1                      -0.3000      0.1539   -1.9491    0.0513
#>  eta2                       0.4999      0.0952    5.2514    0.0000
#>  eta6                       0.2501      0.1540    1.6237    0.1044
#>  Resid_eta6                 0.9784      0.2806    3.4871    0.0005
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0493   10.1431    0.0000
#>  eta4                       0.2501      0.0583    4.2876    0.0000
#>  eta5                       0.5001      0.1070    4.6738    0.0000
#>  Resid_eta5                -0.0056      0.1867   -0.0299    0.9761
#> ________________________________________________________________________________
```
