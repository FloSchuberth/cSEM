...
#>  eta1                      -0.3000      0.1144   -2.6221    0.0087
#>  eta2                       0.4999      0.0866    5.7705    0.0000
#>  eta6                       0.2501      0.1383    1.8088    0.0705
#>  Resid_eta6                 0.9784      0.2506    3.9040    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0538    9.2871    0.0000
#>  eta4                       0.2501      0.0560    4.4687    0.0000
#>  eta5                       0.5001      0.1110    4.5062    0.0000
#>  Resid_eta5                -0.0056      0.1433   -0.0390    0.9689
#> ________________________________________________________________________________
```
