...
#>  eta1                      -0.3000      0.0960   -3.1236    0.0018
#>  eta2                       0.4999      0.0890    5.6170    0.0000
#>  eta6                       0.2501      0.1326    1.8858    0.0593
#>  Resid_eta6                 0.9784      0.2531    3.8663    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0512    9.7602    0.0000
#>  eta4                       0.2501      0.0554    4.5129    0.0000
#>  eta5                       0.5001      0.1034    4.8370    0.0000
#>  Resid_eta5                -0.0056      0.1345   -0.0415    0.9669
#> ________________________________________________________________________________
```
