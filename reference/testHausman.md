...
#>  eta1                      -0.3000      0.1111   -2.7007    0.0069
#>  eta2                       0.4999      0.0907    5.5135    0.0000
#>  eta6                       0.2501      0.1279    1.9552    0.0506
#>  Resid_eta6                 0.9784      0.2984    3.2790    0.0010
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0555    9.0026    0.0000
#>  eta4                       0.2501      0.0467    5.3552    0.0000
#>  eta5                       0.5001      0.1017    4.9183    0.0000
#>  Resid_eta5                -0.0056      0.1387   -0.0403    0.9679
#> ________________________________________________________________________________
```
