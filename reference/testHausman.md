...
#>  eta1                      -0.3000      0.1141   -2.6285    0.0086
#>  eta2                       0.4999      0.1035    4.8280    0.0000
#>  eta6                       0.2501      0.1074    2.3282    0.0199
#>  Resid_eta6                 0.9784      0.2267    4.3163    0.0000
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0561    8.9070    0.0000
#>  eta4                       0.2501      0.0584    4.2841    0.0000
#>  eta5                       0.5001      0.1033    4.8410    0.0000
#>  Resid_eta5                -0.0056      0.1308   -0.0427    0.9659
#> ________________________________________________________________________________
```
