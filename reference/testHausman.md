...
#>  eta1                      -0.3000      0.0872   -3.4394    0.0006
#>  eta2                       0.4999      0.0828    6.0383    0.0000
#>  eta6                       0.2501      0.1182    2.1163    0.0343
#>  Resid_eta6                 0.9784      0.2905    3.3677    0.0008
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0509    9.8189    0.0000
#>  eta4                       0.2501      0.0624    4.0071    0.0001
#>  eta5                       0.5001      0.1141    4.3841    0.0000
#>  Resid_eta5                -0.0056      0.1353   -0.0413    0.9671
#> ________________________________________________________________________________
```
