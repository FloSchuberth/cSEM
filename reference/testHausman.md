...
#>  eta1                      -0.3000      0.1147   -2.6143    0.0089
#>  eta2                       0.4999      0.0911    5.4843    0.0000
#>  eta6                       0.2501      0.1313    1.9050    0.0568
#>  Resid_eta6                 0.9784      0.2867    3.4129    0.0006
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0529    9.4492    0.0000
#>  eta4                       0.2501      0.0650    3.8480    0.0001
#>  eta5                       0.5001      0.1100    4.5456    0.0000
#>  Resid_eta5                -0.0056      0.1514   -0.0369    0.9706
#> ________________________________________________________________________________
```
