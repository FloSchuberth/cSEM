...
#>  eta1                      -0.3000      0.1213   -2.4729    0.0134
#>  eta2                       0.4999      0.0788    6.3451    0.0000
#>  eta6                       0.2501      0.1226    2.0396    0.0414
#>  Resid_eta6                 0.9784      0.2724    3.5914    0.0003
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0468   10.6727    0.0000
#>  eta4                       0.2501      0.0552    4.5289    0.0000
#>  eta5                       0.5001      0.0986    5.0711    0.0000
#>  Resid_eta5                -0.0056      0.1233   -0.0453    0.9639
#> ________________________________________________________________________________
```
