...
#>  eta1                      -0.3000      0.1174   -2.5547    0.0106
#>  eta2                       0.4999      0.0815    6.1368    0.0000
#>  eta6                       0.2501      0.1258    1.9879    0.0468
#>  Resid_eta6                 0.9784      0.2568    3.8108    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0422   11.8536    0.0000
#>  eta4                       0.2501      0.0595    4.2018    0.0000
#>  eta5                       0.5001      0.1048    4.7726    0.0000
#>  Resid_eta5                -0.0056      0.1364   -0.0409    0.9673
#> ________________________________________________________________________________
```
