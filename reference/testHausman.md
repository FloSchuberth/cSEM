...
#>  eta1                      -0.3000      0.1232   -2.4347    0.0149
#>  eta2                       0.4999      0.0917    5.4533    0.0000
#>  eta6                       0.2501      0.1236    2.0232    0.0431
#>  Resid_eta6                 0.9784      0.2620    3.7343    0.0002
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0576    8.6817    0.0000
#>  eta4                       0.2501      0.0545    4.5881    0.0000
#>  eta5                       0.5001      0.0948    5.2754    0.0000
#>  Resid_eta5                -0.0056      0.1206   -0.0463    0.9631
#> ________________________________________________________________________________
```
