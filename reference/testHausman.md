...
#>  eta1                      -0.3000      0.1127   -2.6609    0.0078
#>  eta2                       0.4999      0.1011    4.9423    0.0000
#>  eta6                       0.2501      0.1180    2.1202    0.0340
#>  Resid_eta6                 0.9784      0.2794    3.5022    0.0005
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0576    8.6710    0.0000
#>  eta4                       0.2501      0.0638    3.9225    0.0001
#>  eta5                       0.5001      0.1038    4.8189    0.0000
#>  Resid_eta5                -0.0056      0.1267   -0.0441    0.9649
#> ________________________________________________________________________________
```
