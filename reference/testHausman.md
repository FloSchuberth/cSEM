...
#>  eta1                      -0.3000      0.1010   -2.9714    0.0030
#>  eta2                       0.4999      0.0924    5.4127    0.0000
#>  eta6                       0.2501      0.1184    2.1126    0.0346
#>  Resid_eta6                 0.9784      0.2659    3.6804    0.0002
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0533    9.3805    0.0000
#>  eta4                       0.2501      0.0563    4.4446    0.0000
#>  eta5                       0.5001      0.0984    5.0831    0.0000
#>  Resid_eta5                -0.0056      0.1193   -0.0468    0.9627
#> ________________________________________________________________________________
```
