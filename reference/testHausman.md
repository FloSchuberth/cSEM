...
#>  eta1                      -0.3000      0.1088   -2.7574    0.0058
#>  eta2                       0.4999      0.0962    5.1956    0.0000
#>  eta6                       0.2501      0.1401    1.7850    0.0743
#>  Resid_eta6                 0.9784      0.2458    3.9814    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0525    9.5207    0.0000
#>  eta4                       0.2501      0.0563    4.4392    0.0000
#>  eta5                       0.5001      0.1033    4.8394    0.0000
#>  Resid_eta5                -0.0056      0.1306   -0.0428    0.9659
#> ________________________________________________________________________________
```
