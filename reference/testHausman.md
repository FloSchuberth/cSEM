...
#>  eta1                      -0.3000      0.1532   -1.9578    0.0503
#>  eta2                       0.4999      0.0938    5.3282    0.0000
#>  eta6                       0.2501      0.1424    1.7557    0.0791
#>  Resid_eta6                 0.9784      0.4271    2.2907    0.0220
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0551    9.0681    0.0000
#>  eta4                       0.2501      0.0577    4.3349    0.0000
#>  eta5                       0.5001      0.1001    4.9956    0.0000
#>  Resid_eta5                -0.0056      0.1474   -0.0379    0.9698
#> ________________________________________________________________________________
```
