...
#>  eta1                      -0.3000      0.1389   -2.1593    0.0308
#>  eta2                       0.4999      0.0896    5.5796    0.0000
#>  eta6                       0.2501      0.1360    1.8386    0.0660
#>  Resid_eta6                 0.9784      0.3025    3.2349    0.0012
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0574    8.7148    0.0000
#>  eta4                       0.2501      0.0568    4.4049    0.0000
#>  eta5                       0.5001      0.1175    4.2557    0.0000
#>  Resid_eta5                -0.0056      0.1525   -0.0366    0.9708
#> ________________________________________________________________________________
```
