...
#>  eta1                      -0.3000      0.1387   -2.1631    0.0305
#>  eta2                       0.4999      0.0916    5.4543    0.0000
#>  eta6                       0.2501      0.1573    1.5899    0.1119
#>  Resid_eta6                 0.9784      0.2980    3.2831    0.0010
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0545    9.1692    0.0000
#>  eta4                       0.2501      0.0565    4.4284    0.0000
#>  eta5                       0.5001      0.0996    5.0223    0.0000
#>  Resid_eta5                -0.0056      0.1331   -0.0419    0.9665
#> ________________________________________________________________________________
```
