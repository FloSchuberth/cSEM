...
#>  eta1                      -0.3000      0.1063   -2.8227    0.0048
#>  eta2                       0.4999      0.0932    5.3630    0.0000
#>  eta6                       0.2501      0.1173    2.1321    0.0330
#>  Resid_eta6                 0.9784      0.2745    3.5639    0.0004
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0490   10.1936    0.0000
#>  eta4                       0.2501      0.0610    4.1018    0.0000
#>  eta5                       0.5001      0.1106    4.5203    0.0000
#>  Resid_eta5                -0.0056      0.1488   -0.0375    0.9701
#> ________________________________________________________________________________
```
