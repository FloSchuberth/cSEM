...
#>  eta1                      -0.3000      0.0861   -3.4830    0.0005
#>  eta2                       0.4999      0.0974    5.1316    0.0000
#>  eta6                       0.2501      0.1107    2.2597    0.0238
#>  Resid_eta6                 0.9784      0.2613    3.7451    0.0002
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0480   10.4081    0.0000
#>  eta4                       0.2501      0.0572    4.3744    0.0000
#>  eta5                       0.5001      0.0856    5.8427    0.0000
#>  Resid_eta5                -0.0056      0.1146   -0.0487    0.9612
#> ________________________________________________________________________________
```
