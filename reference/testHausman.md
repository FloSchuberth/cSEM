...
#>  eta1                      -0.3000      0.1087   -2.7601    0.0058
#>  eta2                       0.4999      0.0865    5.7821    0.0000
#>  eta6                       0.2501      0.1325    1.8879    0.0590
#>  Resid_eta6                 0.9784      0.3025    3.2343    0.0012
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0510    9.8016    0.0000
#>  eta4                       0.2501      0.0482    5.1903    0.0000
#>  eta5                       0.5001      0.0997    5.0182    0.0000
#>  Resid_eta5                -0.0056      0.1341   -0.0416    0.9668
#> ________________________________________________________________________________
```
