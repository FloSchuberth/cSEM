...
#>  eta1                      -0.3000      0.1251   -2.3986    0.0165
#>  eta2                       0.4999      0.0895    5.5836    0.0000
#>  eta6                       0.2501      0.1199    2.0865    0.0369
#>  Resid_eta6                 0.9784      0.2564    3.8158    0.0001
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0530    9.4260    0.0000
#>  eta4                       0.2501      0.0629    3.9768    0.0001
#>  eta5                       0.5001      0.0905    5.5289    0.0000
#>  Resid_eta5                -0.0056      0.1249   -0.0447    0.9643
#> ________________________________________________________________________________
```
