...
#>  eta1                      -0.3000      0.1087   -2.7605    0.0058
#>  eta2                       0.4999      0.0911    5.4871    0.0000
#>  eta6                       0.2501      0.1280    1.9541    0.0507
#>  Resid_eta6                 0.9784      0.3044    3.2146    0.0013
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0479   10.4376    0.0000
#>  eta4                       0.2501      0.0605    4.1335    0.0000
#>  eta5                       0.5001      0.0956    5.2322    0.0000
#>  Resid_eta5                -0.0056      0.1207   -0.0463    0.9631
#> ________________________________________________________________________________
```
