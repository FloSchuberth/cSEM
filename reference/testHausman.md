...
#>  eta1                      -0.3000      0.1036   -2.8943    0.0038
#>  eta2                       0.4999      0.0864    5.7887    0.0000
#>  eta6                       0.2501      0.1154    2.1673    0.0302
#>  Resid_eta6                 0.9784      0.2745    3.5638    0.0004
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0501    9.9849    0.0000
#>  eta4                       0.2501      0.0649    3.8544    0.0001
#>  eta5                       0.5001      0.1033    4.8438    0.0000
#>  Resid_eta5                -0.0056      0.1328   -0.0420    0.9665
#> ________________________________________________________________________________
```
