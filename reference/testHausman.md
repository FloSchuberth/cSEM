...
#>  eta1                      -0.3000      0.1179   -2.5454    0.0109
#>  eta2                       0.4999      0.0939    5.3249    0.0000
#>  eta6                       0.2501      0.1294    1.9328    0.0533
#>  Resid_eta6                 0.9784      0.3004    3.2568    0.0011
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0552    9.0557    0.0000
#>  eta4                       0.2501      0.0521    4.7979    0.0000
#>  eta5                       0.5001      0.1013    4.9380    0.0000
#>  Resid_eta5                -0.0056      0.1284   -0.0435    0.9653
#> ________________________________________________________________________________
```
