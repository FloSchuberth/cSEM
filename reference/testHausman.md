...
#>  eta1                      -0.3000      0.1272   -2.3581    0.0184
#>  eta2                       0.4999      0.0804    6.2209    0.0000
#>  eta6                       0.2501      0.1443    1.7335    0.0830
#>  Resid_eta6                 0.9784      0.2797    3.4983    0.0005
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0486   10.2918    0.0000
#>  eta4                       0.2501      0.0526    4.7522    0.0000
#>  eta5                       0.5001      0.0966    5.1763    0.0000
#>  Resid_eta5                -0.0056      0.1259   -0.0444    0.9646
#> ________________________________________________________________________________
```
