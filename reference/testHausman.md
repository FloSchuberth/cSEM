...
#>  eta1                      -0.3000      0.1576   -1.9032    0.0570
#>  eta2                       0.4999      0.0830    6.0212    0.0000
#>  eta6                       0.2501      0.1600    1.5629    0.1181
#>  Resid_eta6                 0.9784      0.3114    3.1417    0.0017
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0628    7.9578    0.0000
#>  eta4                       0.2501      0.0569    4.3917    0.0000
#>  eta5                       0.5001      0.1123    4.4539    0.0000
#>  Resid_eta5                -0.0056      0.1516   -0.0368    0.9706
#> ________________________________________________________________________________
```
