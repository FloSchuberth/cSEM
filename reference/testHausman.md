...
#>  eta1                      -0.3000      0.1001   -2.9962    0.0027
#>  eta2                       0.4999      0.0828    6.0343    0.0000
#>  eta6                       0.2501      0.1081    2.3133    0.0207
#>  Resid_eta6                 0.9784      0.2225    4.3981    0.0000
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0498   10.0290    0.0000
#>  eta4                       0.2501      0.0522    4.7900    0.0000
#>  eta5                       0.5001      0.0982    5.0913    0.0000
#>  Resid_eta5                -0.0056      0.1235   -0.0452    0.9639
#> ________________________________________________________________________________
```
