...
#>  eta1                      -0.3000      0.1146   -2.6165    0.0089
#>  eta2                       0.4999      0.0839    5.9607    0.0000
#>  eta6                       0.2501      0.1164    2.1494    0.0316
#>  Resid_eta6                 0.9784      0.2251    4.3461    0.0000
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0576    8.6726    0.0000
#>  eta4                       0.2501      0.0625    3.9985    0.0001
#>  eta5                       0.5001      0.1093    4.5768    0.0000
#>  Resid_eta5                -0.0056      0.1443   -0.0387    0.9691
#> ________________________________________________________________________________
```
