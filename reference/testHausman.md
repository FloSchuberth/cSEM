...
#>  eta1                      -0.3000      0.1336   -2.2458    0.0247
#>  eta2                       0.4999      0.0935    5.3454    0.0000
#>  eta6                       0.2501      0.1741    1.4367    0.1508
#>  Resid_eta6                 0.9784      0.3937    2.4852    0.0129
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0614    8.1360    0.0000
#>  eta4                       0.2501      0.0513    4.8752    0.0000
#>  eta5                       0.5001      0.0937    5.3381    0.0000
#>  Resid_eta5                -0.0056      0.5721   -0.0098    0.9922
#> ________________________________________________________________________________
```
