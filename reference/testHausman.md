...
#>  eta1                      -0.3000      0.1060   -2.8300    0.0047
#>  eta2                       0.4999      0.0844    5.9195    0.0000
#>  eta6                       0.2501      0.1254    1.9951    0.0460
#>  Resid_eta6                 0.9784      0.3028    3.2312    0.0012
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0523    9.5663    0.0000
#>  eta4                       0.2501      0.0477    5.2402    0.0000
#>  eta5                       0.5001      0.1033    4.8409    0.0000
#>  Resid_eta5                -0.0056      0.1301   -0.0429    0.9658
#> ________________________________________________________________________________
```
