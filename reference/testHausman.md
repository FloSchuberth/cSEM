...
#>  eta1                      -0.3000      0.0825   -3.6349    0.0003
#>  eta2                       0.4999      0.0805    6.2094    0.0000
#>  eta6                       0.2501      0.1120    2.2339    0.0255
#>  Resid_eta6                 0.9784      0.2208    4.4320    0.0000
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0494   10.1171    0.0000
#>  eta4                       0.2501      0.0539    4.6398    0.0000
#>  eta5                       0.5001      0.1043    4.7957    0.0000
#>  Resid_eta5                -0.0056      0.1318   -0.0424    0.9662
#> ________________________________________________________________________________
```
