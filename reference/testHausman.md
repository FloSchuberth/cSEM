...
#>  eta1                      -0.3000      0.1236   -2.4273    0.0152
#>  eta2                       0.4999      0.0988    5.0575    0.0000
#>  eta6                       0.2501      0.1273    1.9646    0.0495
#>  Resid_eta6                 0.9784      0.3153    3.1028    0.0019
#> 
#>   Dependent construct: 'eta6'
#> 
#>  Independent construct    Estimate  Std. error   t-stat.   p-value
#>  eta3                       0.4999      0.0585    8.5444    0.0000
#>  eta4                       0.2501      0.0538    4.6511    0.0000
#>  eta5                       0.5001      0.0961    5.2044    0.0000
#>  Resid_eta5                -0.0056      0.1323   -0.0422    0.9663
#> ________________________________________________________________________________
```
