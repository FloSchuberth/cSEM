...
#>   ..$ imag1: int [1:250] 8 7 8 9 8 9 8 8 8 8 ...
#>   ..$ imag2: int [1:250] 7 4 6 8 8 10 8 8 8 10 ...
#>   ..$ imag3: int [1:250] 6 5 7 9 8 7 8 7 8 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 7 8 6 8 9 7 9 9 7 ...
#>   ..$ imag2: int [1:250] 10 9 10 7 8 9 7 9 10 7 ...
#>   ..$ imag3: int [1:250] 10 8 8 7 8 10 7 7 10 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 7 10 10 8 6 9 10 0 8 ...
#>   ..$ imag2: int [1:250] 5 7 10 10 7 7 8 9 4 8 ...
#>   ..$ imag3: int [1:250] 5 8 10 10 8 7 8 9 7 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.452 -0.783 -0.264 1.764 0.854 ...
#>   .. ..$ x2   : num [1:10] -0.00514 -0.20467 -1.19635 0.36982 -0.98968 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.1175 -1.3344 0.1516 0.0845 -0.7685 ...
#>   .. ..$ x2   : num [1:10] -1.152 -1.814 -0.284 0.786 -2.102 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.901 -0.084 -0.23 -0.946 -0.752 ...
#>   .. ..$ x2   : num [1:10] -0.405 -0.708 -0.463 0.47 0.463 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0841 -1.0934 -0.6857 -0.0887 -1.2775 ...
#>   .. ..$ x2   : num [1:10] -3.311 0.892 -0.982 -1.388 -1.472 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.8539 0.4856 0.00705 1.39743 0.16262 ...
#>   .. ..$ x2   : num [1:10] -0.99 -0.462 0.879 -1.911 -0.576 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.419 0.206 0.496 1.292 -0.559 ...
#>   .. ..$ x2   : num [1:10] 0.212 1.901 1.373 -0.805 -1.388 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.185 -0.665 -0.18 -0.773 0.419 ...
#>   .. ..$ x2   : num [1:10] -0.161 0.96 0.16 0.536 0.212 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.62 0.412 -0.752 0.611 -1.428 ...
#>   .. ..$ x2   : num [1:10] -1.5701 -0.0186 0.4627 -1.4053 -0.2837 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 -0.686 -0.319 0.152 -1.277 ...
#>   .. ..$ x2   : num [1:10] -0.331 -0.982 -0.501 -0.284 -1.472 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (a97be3633145cc9f5f2814f1c2f7ba75-14); on a97be3633145cc9f5f2814f1c2f7ba75@runnervmvrwv9<7518>]
