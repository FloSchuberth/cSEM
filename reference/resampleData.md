...
#>   ..$ imag1: int [1:250] 7 10 9 8 9 8 3 8 10 8 ...
#>   ..$ imag2: int [1:250] 7 10 9 9 9 8 3 8 10 6 ...
#>   ..$ imag3: int [1:250] 7 10 9 10 9 8 3 8 10 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 10 5 9 7 9 9 10 9 8 ...
#>   ..$ imag2: int [1:250] 7 10 7 10 7 9 10 10 9 9 ...
#>   ..$ imag3: int [1:250] 8 10 8 10 7 9 9 10 9 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 8 10 10 7 8 9 8 8 10 ...
#>   ..$ imag2: int [1:250] 10 8 10 10 7 6 10 7 5 9 ...
#>   ..$ imag3: int [1:250] 10 9 10 10 7 9 9 8 9 7 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.752 0.837 0.629 0.79 0.496 ...
#>   .. ..$ x2   : num [1:10] 0.463 0.796 -0.14 1.227 1.373 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.611 1.871 1.764 0.619 -0.714 ...
#>   .. ..$ x2   : num [1:10] -1.405 -1.049 0.37 0.314 0.74 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.4277 -0.0841 -0.9009 -0.9773 -0.9008 ...
#>   .. ..$ x2   : num [1:10] -0.284 -3.311 -0.405 0.693 -0.755 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.0664 -0.6203 0.8517 0.0749 -0.7662 ...
#>   .. ..$ x2   : num [1:10] 0.897 -1.57 -0.947 -0.81 -0.386 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.595 0.41 1.176 0.794 -0.279 ...
#>   .. ..$ x2   : num [1:10] -0.265 -1.276 -0.126 0.362 2.196 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.206 0.441 0.664 -0.773 -0.901 ...
#>   .. ..$ x2   : num [1:10] 1.901 0.972 -0.113 0.536 -0.405 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.527 -0.626 0.305 0.412 1.066 ...
#>   .. ..$ x2   : num [1:10] -0.8705 -0.0422 0.7915 -0.0186 0.8968 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.977 -0.768 1.234 0.852 1.764 ...
#>   .. ..$ x2   : num [1:10] 0.693 -2.102 -0.564 -0.947 0.37 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.37661 0.00705 1.17719 -1.59548 -0.76617 ...
#>   .. ..$ x2   : num [1:10] 1.092 0.879 0.529 -0.265 -0.386 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (30738f37a2c75f96a82de715bd7e29c9-14); on 30738f37a2c75f96a82de715bd7e29c9@runnervmmtnos<7626>]
