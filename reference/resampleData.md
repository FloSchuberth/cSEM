...
#>   ..$ imag1: int [1:250] 9 10 10 7 4 8 9 7 9 8 ...
#>   ..$ imag2: int [1:250] 9 10 9 9 8 7 9 8 9 8 ...
#>   ..$ imag3: int [1:250] 10 10 9 9 8 8 6 8 10 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 6 7 8 8 8 8 10 8 9 ...
#>   ..$ imag2: int [1:250] 6 7 7 7 8 9 8 10 7 10 ...
#>   ..$ imag3: int [1:250] 6 7 7 6 8 10 8 10 7 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 8 10 9 10 6 5 10 4 9 ...
#>   ..$ imag2: int [1:250] 10 8 10 10 8 6 7 9 5 10 ...
#>   ..$ imag3: int [1:250] 10 8 10 10 9 5 4 9 5 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.8375 -0.0479 -0.242 -0.1804 -0.6857 ...
#>   .. ..$ x2   : num [1:10] 0.796 -0.923 0.667 0.16 -0.982 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.496 0.34 0.152 -1.334 -0.665 ...
#>   .. ..$ x2   : num [1:10] 1.373 -0.972 -0.284 -1.814 0.96 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.773 0.794 -0.468 -0.62 -0.768 ...
#>   .. ..$ x2   : num [1:10] 0.536 0.362 -0.536 -1.57 -2.102 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.634 -0.783 -1.568 0.664 0.852 ...
#>   .. ..$ x2   : num [1:10] 0.97 -0.205 2.708 -0.113 -0.947 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.3344 -0.6857 -0.9773 -0.0193 0.6286 ...
#>   .. ..$ x2   : num [1:10] -1.814 -0.982 0.693 -0.409 -0.14 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.779 -0.0062 -1.2613 0.5269 -0.735 ...
#>   .. ..$ x2   : num [1:10] 0.975 1.845 -1.649 -0.87 -0.331 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.6259 0.5269 1.7787 -0.1804 0.0845 ...
#>   .. ..$ x2   : num [1:10] -0.0422 -0.8705 -1.0936 0.1602 0.7856 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.348 0.382 0.3 -2.399 -1.277 ...
#>   .. ..$ x2   : num [1:10] -0.3413 0.5385 1.7971 0.0099 -1.4722 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.6652 0.6029 -0.242 -0.0841 0.4856 ...
#>   .. ..$ x2   : num [1:10] 0.96 0.449 0.667 -3.311 -0.462 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (bc754261ce5c8bbda9b5cafc6ede74eb-13); on bc754261ce5c8bbda9b5cafc6ede74eb@runnervmrg6be<7721>]
