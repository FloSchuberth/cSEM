...
#>   ..$ imag1: int [1:250] 8 9 8 9 10 3 5 7 6 8 ...
#>   ..$ imag2: int [1:250] 10 9 8 10 10 4 5 7 5 5 ...
#>   ..$ imag3: int [1:250] 10 9 8 10 10 3 7 8 5 6 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 10 8 8 9 5 7 5 10 8 ...
#>   ..$ imag2: int [1:250] 7 10 9 9 9 4 7 5 10 8 ...
#>   ..$ imag3: int [1:250] 4 8 9 9 9 4 6 7 10 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 10 8 8 8 3 8 9 8 7 ...
#>   ..$ imag2: int [1:250] 8 10 9 7 5 4 9 7 8 8 ...
#>   ..$ imag3: int [1:250] 8 10 8 7 6 3 10 7 8 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.4636 -0.7662 0.7936 -0.0062 0.4856 ...
#>   .. ..$ x2   : num [1:10] -0.535 -0.386 0.362 1.845 -0.462 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.7136 0.6344 -0.2607 -0.084 0.0845 ...
#>   .. ..$ x2   : num [1:10] 0.74 0.97 0.286 -0.708 0.786 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.6857 0.4407 0.452 -0.0887 -0.6203 ...
#>   .. ..$ x2   : num [1:10] -0.98192 0.9717 -0.00514 -1.38825 -1.57014 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.4407 -0.773 -0.6203 0.9025 -0.0479 ...
#>   .. ..$ x2   : num [1:10] 0.972 0.536 -1.57 2.454 -0.923 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 -0.5585 -0.7662 -0.4889 0.412 ...
#>   .. ..$ x2   : num [1:10] 1.8448 -1.3884 -0.3859 0.709 -0.0186 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.837 1.779 0.41 -0.665 0.184 ...
#>   .. ..$ x2   : num [1:10] 0.796 -1.094 -1.276 0.96 2.375 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.852 1.234 -0.489 0.496 -1.093 ...
#>   .. ..$ x2   : num [1:10] -0.947 -0.564 0.709 1.373 0.892 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.2923 0.0377 -0.5585 1.3974 -2.4948 ...
#>   .. ..$ x2   : num [1:10] -0.805 0.192 -1.388 -1.911 0.923 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.193 -0.375 0.629 0.184 -0.152 ...
#>   .. ..$ x2   : num [1:10] -0.61 -0.868 -0.14 2.375 2.011 ...
