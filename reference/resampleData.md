...
#>   ..$ imag1: int [1:250] 8 8 8 8 8 10 8 6 10 8 ...
#>   ..$ imag2: int [1:250] 6 9 10 6 8 10 10 8 9 8 ...
#>   ..$ imag3: int [1:250] 9 9 8 7 8 10 8 8 9 3 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 8 8 10 9 8 7 8 6 8 ...
#>   ..$ imag2: int [1:250] 10 8 8 10 8 8 8 6 6 8 ...
#>   ..$ imag3: int [1:250] 10 8 8 9 9 3 8 3 5 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 4 7 9 9 7 10 4 5 8 ...
#>   ..$ imag2: int [1:250] 7 1 8 7 9 5 10 5 9 6 ...
#>   ..$ imag3: int [1:250] 8 4 9 8 9 7 10 5 10 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 1.234 -0.0193 -0.0479 0.4104 1.6465 ...
#>   .. ..$ x2   : num [1:10] -0.564 -0.409 -0.923 -1.276 -0.973 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.495 0.619 0.163 -0.766 -0.152 ...
#>   .. ..$ x2   : num [1:10] 0.923 0.314 -0.576 -0.386 2.011 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.7685 0.452 0.0377 -0.4636 -0.3926 ...
#>   .. ..$ x2   : num [1:10] -2.10225 -0.00514 0.19244 -0.53507 0.49928 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 0.3003 0.4188 0.7902 -0.9009 ...
#>   .. ..$ x2   : num [1:10] -0.81 1.797 0.212 1.227 -0.405 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.603 0.184 1.185 -0.901 0.305 ...
#>   .. ..$ x2   : num [1:10] 0.449 2.375 -0.161 -0.755 0.792 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 0.903 -1.595 1.764 -0.946 ...
#>   .. ..$ x2   : num [1:10] -0.331 2.454 -0.265 0.37 0.47 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0841 0.9025 0.611 0.8539 -0.6259 ...
#>   .. ..$ x2   : num [1:10] -3.3107 2.4544 -1.4053 -0.9897 -0.0422 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.2303 -1.2613 0.8375 0.0377 1.1762 ...
#>   .. ..$ x2   : num [1:10] -0.463 -1.649 0.796 0.192 -0.126 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.9618 -1.5955 0.4959 -0.628 -0.0469 ...
#>   .. ..$ x2   : num [1:10] -0.0325 -0.2646 1.3726 0.7362 1.3658 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (954c1d2d696ab1eddb1d4706d50d9a76-16); on 954c1d2d696ab1eddb1d4706d50d9a76@runnervm7b5n9<7657>]
