...
#>   ..$ imag1: int [1:250] 10 9 9 8 5 8 8 8 8 10 ...
#>   ..$ imag2: int [1:250] 10 9 9 8 9 8 10 9 9 10 ...
#>   ..$ imag3: int [1:250] 10 9 9 9 10 9 10 9 8 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 10 6 9 10 8 4 8 8 9 ...
#>   ..$ imag2: int [1:250] 9 10 8 10 8 8 8 5 8 9 ...
#>   ..$ imag3: int [1:250] 8 10 8 9 8 10 8 9 8 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 7 8 9 8 9 8 8 8 8 ...
#>   ..$ imag2: int [1:250] 7 7 8 9 10 8 8 8 9 8 ...
#>   ..$ imag3: int [1:250] 8 8 8 9 10 9 9 8 9 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.4959 -0.2303 0.0845 2.1499 -1.2613 ...
#>   .. ..$ x2   : num [1:10] 1.373 -0.463 0.786 -1.829 -1.649 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.634 -0.242 0.596 -1.277 -0.261 ...
#>   .. ..$ x2   : num [1:10] 0.97 1.066 0.549 -1.472 0.286 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.2793 0.3003 -0.0469 0.4188 -0.9456 ...
#>   .. ..$ x2   : num [1:10] 2.196 1.797 1.366 0.212 0.47 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.3748 -0.264 -0.6652 0.8375 -0.0193 ...
#>   .. ..$ x2   : num [1:10] -0.868 -1.196 0.96 0.796 -0.409 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.452 -0.773 2.15 0.184 -0.489 ...
#>   .. ..$ x2   : num [1:10] -0.00514 0.53592 -1.82863 2.37546 0.70895 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.752 -0.242 0.611 0.496 0.41 ...
#>   .. ..$ x2   : num [1:10] 0.463 0.667 -1.405 1.373 -1.276 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.755 -0.977 0.634 1.764 -0.773 ...
#>   .. ..$ x2   : num [1:10] 0.489 0.693 0.97 0.37 0.536 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.752 1.397 -0.628 -0.23 1.234 ...
#>   .. ..$ x2   : num [1:10] 0.463 -1.911 0.736 -0.463 -0.564 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.4856 0.0845 0.5964 1.1175 1.2923 ...
#>   .. ..$ x2   : num [1:10] -0.462 0.786 0.549 -1.152 -0.805 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (8a8364e561a61675ba219d1ef3bb8b75-17); on 8a8364e561a61675ba219d1ef3bb8b75@runnervmvrwv9<7157>]
