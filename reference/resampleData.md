...
#>   ..$ imag1: int [1:250] 7 8 7 7 9 8 9 6 9 10 ...
#>   ..$ imag2: int [1:250] 6 9 7 8 7 6 9 8 10 10 ...
#>   ..$ imag3: int [1:250] 9 5 7 9 8 9 9 8 10 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 8 10 8 8 9 9 9 8 9 ...
#>   ..$ imag2: int [1:250] 10 6 10 9 8 9 9 10 8 10 ...
#>   ..$ imag3: int [1:250] 10 9 10 9 8 9 9 8 8 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 8 8 9 8 10 6 8 8 ...
#>   ..$ imag2: int [1:250] 6 9 6 9 10 8 10 6 8 7 ...
#>   ..$ imag3: int [1:250] 3 9 9 5 9 7 10 6 8 6 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -1.33435 0.00705 -0.62795 -0.77298 -0.08869 ...
#>   .. ..$ x2   : num [1:10] -1.814 0.879 0.736 0.536 -1.388 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.794 0.962 0.163 -1.277 0.596 ...
#>   .. ..$ x2   : num [1:10] 0.3624 -0.0325 -0.5763 -1.4722 0.5492 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.977 -2.348 0.903 1.292 0.611 ...
#>   .. ..$ x2   : num [1:10] 0.693 -0.341 2.454 -0.805 -1.405 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.44069 -0.77298 0.00705 0.63436 -0.26399 ...
#>   .. ..$ x2   : num [1:10] 0.972 0.536 0.879 0.97 -1.196 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6029 -0.0193 0.1626 1.7787 -2.4948 ...
#>   .. ..$ x2   : num [1:10] 0.449 -0.409 -0.576 -1.094 0.923 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.377 -0.901 0.664 1.871 0.34 ...
#>   .. ..$ x2   : num [1:10] 1.092 -0.405 -0.113 -1.049 -0.972 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.261 -0.468 -0.755 1.764 0.184 ...
#>   .. ..$ x2   : num [1:10] -1.649 -0.536 0.489 0.37 2.375 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.779 -0.783 -0.393 0.611 -0.752 ...
#>   .. ..$ x2   : num [1:10] -1.094 -0.205 0.499 -1.405 0.463 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 1.177 0.412 -2.495 -0.901 ...
#>   .. ..$ x2   : num [1:10] -0.3313 0.529 -0.0186 0.9231 -0.4048 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (6c056c847a2c95670380adde93dbc948-16); on 6c056c847a2c95670380adde93dbc948@runnervm7b5n9<7171>]
