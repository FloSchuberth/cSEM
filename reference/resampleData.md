...
#>   ..$ imag1: int [1:250] 10 8 8 6 9 5 10 4 7 9 ...
#>   ..$ imag2: int [1:250] 10 7 8 6 10 3 10 5 7 9 ...
#>   ..$ imag3: int [1:250] 10 8 8 4 10 4 10 5 7 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 4 6 9 4 8 7 9 7 4 ...
#>   ..$ imag2: int [1:250] 8 1 6 9 5 8 7 9 7 6 ...
#>   ..$ imag3: int [1:250] 8 4 5 9 5 8 8 9 6 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 8 9 7 7 5 8 7 8 10 ...
#>   ..$ imag2: int [1:250] 6 7 9 7 8 5 9 8 9 10 ...
#>   ..$ imag3: int [1:250] 6 7 10 7 9 5 9 8 9 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.628 -1.428 -0.766 -1.093 0.603 ...
#>   .. ..$ x2   : num [1:10] 0.736 -0.284 -0.386 0.892 0.449 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.319 -0.279 1.646 -0.783 1.377 ...
#>   .. ..$ x2   : num [1:10] -0.501 2.196 -0.973 -0.205 1.092 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 0.9618 0.6344 1.3974 1.1772 ...
#>   .. ..$ x2   : num [1:10] 1.8448 -0.0325 0.9703 -1.9112 0.529 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.428 -0.977 0.34 -0.393 1.066 ...
#>   .. ..$ x2   : num [1:10] -0.284 0.693 -0.972 0.499 0.897 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.334 -0.735 -0.084 -0.946 0.596 ...
#>   .. ..$ x2   : num [1:10] -1.814 -0.331 -0.708 0.47 0.549 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.397 0.3 0.629 -0.714 0.452 ...
#>   .. ..$ x2   : num [1:10] -1.91115 1.79714 -0.1395 0.73952 -0.00514 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0469 -1.2613 0.4188 -0.779 -0.735 ...
#>   .. ..$ x2   : num [1:10] 1.366 -1.649 0.212 0.975 -0.331 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.903 -0.628 0.79 -0.62 -0.665 ...
#>   .. ..$ x2   : num [1:10] 2.454 0.736 1.227 -1.57 0.96 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 -0.2793 0.8539 1.7637 1.3766 ...
#>   .. ..$ x2   : num [1:10] -0.81 2.2 -0.99 0.37 1.09 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (ed95bf0e586744f88cd3ef4c1d268cd1-25); on ed95bf0e586744f88cd3ef4c1d268cd1@runnervmymu0l<7743>]
