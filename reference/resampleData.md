...
#>   ..$ imag1: int [1:250] 8 9 8 5 9 7 8 10 5 8 ...
#>   ..$ imag2: int [1:250] 7 10 6 8 9 7 8 9 3 6 ...
#>   ..$ imag3: int [1:250] 6 9 9 8 9 8 10 9 4 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 7 10 9 8 8 10 9 6 8 ...
#>   ..$ imag2: int [1:250] 9 7 10 8 8 8 10 10 8 8 ...
#>   ..$ imag3: int [1:250] 9 7 8 8 8 8 10 9 7 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 8 10 7 8 5 7 8 8 ...
#>   ..$ imag2: int [1:250] 8 8 7 10 8 5 5 8 5 8 ...
#>   ..$ imag3: int [1:250] 9 9 10 10 9 5 6 8 6 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.752 -0.735 -0.468 -0.464 -0.768 ...
#>   .. ..$ x2   : num [1:10] 0.463 -0.331 -0.536 -0.535 -2.102 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.3003 -0.773 0.0377 1.1762 -0.628 ...
#>   .. ..$ x2   : num [1:10] 1.797 0.536 0.192 -0.126 0.736 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.6465 -0.3926 0.0845 -1.3344 0.3055 ...
#>   .. ..$ x2   : num [1:10] -0.973 0.499 0.786 -1.814 0.792 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.852 -1.277 0.163 -1.334 -0.665 ...
#>   .. ..$ x2   : num [1:10] -0.947 -1.472 -0.576 -1.814 0.96 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.348 -1.568 1.234 -0.783 1.117 ...
#>   .. ..$ x2   : num [1:10] -0.341 2.708 -0.564 -0.205 -1.152 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.193 0.4407 -0.2793 0.4188 -0.0479 ...
#>   .. ..$ x2   : num [1:10] -0.61 0.972 2.196 0.212 -0.923 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.2793 -1.4277 -0.628 -0.0841 0.6029 ...
#>   .. ..$ x2   : num [1:10] 2.196 -0.284 0.736 -3.311 0.449 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.946 -2.495 -0.714 1.377 0.664 ...
#>   .. ..$ x2   : num [1:10] 0.47 0.923 0.74 1.092 -0.113 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 2.15 -0.489 -0.755 -0.752 0.184 ...
#>   .. ..$ x2   : num [1:10] -1.829 0.709 0.489 0.463 2.375 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (558a08d780c5a0afe66d0dd2f762aa14-14); on 558a08d780c5a0afe66d0dd2f762aa14@runnervmkkn4f<7606>]
