...
#>   ..$ imag1: int [1:250] 10 7 8 9 7 8 9 10 10 10 ...
#>   ..$ imag2: int [1:250] 10 9 8 10 7 7 10 10 10 10 ...
#>   ..$ imag3: int [1:250] 10 8 9 10 7 7 10 10 10 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 9 7 9 10 10 8 4 6 6 ...
#>   ..$ imag2: int [1:250] 10 10 8 10 10 10 7 8 7 6 ...
#>   ..$ imag3: int [1:250] 9 10 8 9 10 10 10 8 7 6 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 6 8 7 8 9 7 8 10 7 ...
#>   ..$ imag2: int [1:250] 8 8 4 8 8 10 7 9 9 8 ...
#>   ..$ imag3: int [1:250] 9 8 6 8 8 10 8 9 9 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.393 0.34 -0.766 0.486 -0.901 ...
#>   .. ..$ x2   : num [1:10] 0.499 -0.972 -0.386 -0.462 -0.755 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.234 -0.628 1.1772 0.193 -0.0479 ...
#>   .. ..$ x2   : num [1:10] -0.564 0.736 0.529 -0.61 -0.923 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.1762 1.2923 1.3766 0.611 0.0749 ...
#>   .. ..$ x2   : num [1:10] -0.126 -0.805 1.092 -1.405 -0.81 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.319 0.452 -0.901 -0.755 -0.62 ...
#>   .. ..$ x2   : num [1:10] -0.50119 -0.00514 -0.40481 0.48946 -1.57014 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.766 -0.264 0.441 1.646 -0.559 ...
#>   .. ..$ x2   : num [1:10] -0.386 -1.196 0.972 -0.973 -1.388 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.83746 -0.68571 -0.77298 0.00705 -1.09341 ...
#>   .. ..$ x2   : num [1:10] 0.796 -0.982 0.536 0.879 0.892 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.79 0.412 1.292 -1.568 -0.735 ...
#>   .. ..$ x2   : num [1:10] 1.2269 -0.0186 -0.8047 2.7082 -0.3313 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.1804 0.6029 -0.0469 -0.0887 -0.7555 ...
#>   .. ..$ x2   : num [1:10] 0.16 0.449 1.366 -1.388 0.489 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.559 -0.261 -0.152 -0.279 -0.977 ...
#>   .. ..$ x2   : num [1:10] -1.388 0.286 2.011 2.196 0.693 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (54eb13b13a526b2a6cdeb8c67b18404f-13); on 54eb13b13a526b2a6cdeb8c67b18404f@runnervmmtnos<7594>]
