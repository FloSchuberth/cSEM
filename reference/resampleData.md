...
#>   ..$ imag1: int [1:250] 10 8 8 10 8 8 10 8 9 7 ...
#>   ..$ imag2: int [1:250] 10 8 7 0 6 8 10 8 8 8 ...
#>   ..$ imag3: int [1:250] 10 9 8 0 3 9 10 8 9 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 2 10 6 8 8 8 8 6 9 7 ...
#>   ..$ imag2: int [1:250] 2 8 8 9 8 6 9 6 9 8 ...
#>   ..$ imag3: int [1:250] 8 8 8 7 8 9 8 6 10 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 6 7 7 10 8 6 8 6 6 ...
#>   ..$ imag2: int [1:250] 8 6 9 7 8 6 6 8 5 8 ...
#>   ..$ imag3: int [1:250] 9 4 9 7 9 7 7 8 5 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -2.4948 -0.7827 1.3974 -0.9773 -0.0469 ...
#>   .. ..$ x2   : num [1:10] 0.923 -0.205 -1.911 0.693 1.366 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.755 -0.152 -0.62 -0.752 0.634 ...
#>   .. ..$ x2   : num [1:10] 0.489 2.011 -1.57 0.463 0.97 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.5955 0.4407 -0.2289 -1.5677 -0.0841 ...
#>   .. ..$ x2   : num [1:10] -0.265 0.972 -1.178 2.708 -3.311 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.852 0.34 -0.946 1.292 -0.375 ...
#>   .. ..$ x2   : num [1:10] -0.947 -0.972 0.47 -0.805 -0.868 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.628 -2.348 0.193 0.3 -2.495 ...
#>   .. ..$ x2   : num [1:10] 0.736 -0.341 -0.61 1.797 0.923 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.596 -0.559 1.117 0.152 0.452 ...
#>   .. ..$ x2   : num [1:10] 0.54922 -1.38843 -1.1516 -0.284 -0.00514 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.292 1.234 -0.766 0.903 -0.665 ...
#>   .. ..$ x2   : num [1:10] -0.805 -0.564 -0.386 2.454 0.96 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.319 1.764 0.193 0.837 1.646 ...
#>   .. ..$ x2   : num [1:10] -0.501 0.37 -0.61 0.796 -0.973 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0377 1.8714 0.1516 0.9618 1.3974 ...
#>   .. ..$ x2   : num [1:10] 0.1924 -1.049 -0.284 -0.0325 -1.9112 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (b366b397b6e07a94a518be8f10f7f745-16); on b366b397b6e07a94a518be8f10f7f745@runnervmvrwv9<7212>]
