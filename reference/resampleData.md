...
#>   ..$ imag1: int [1:250] 6 6 6 8 7 8 8 7 8 9 ...
#>   ..$ imag2: int [1:250] 8 7 8 8 8 8 8 7 6 9 ...
#>   ..$ imag3: int [1:250] 7 7 8 3 8 8 8 7 6 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 9 9 10 10 10 10 9 8 8 ...
#>   ..$ imag2: int [1:250] 7 9 9 10 10 10 10 9 8 5 ...
#>   ..$ imag3: int [1:250] 7 9 9 10 10 10 10 9 8 5 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 4 7 9 8 10 9 6 4 9 4 ...
#>   ..$ imag2: int [1:250] 1 7 9 6 10 9 7 6 5 8 ...
#>   ..$ imag3: int [1:250] 4 7 9 8 10 6 7 8 7 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.634 -1.277 0.193 -0.319 0.596 ...
#>   .. ..$ x2   : num [1:10] 0.97 -1.472 -0.61 -0.501 0.549 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.7136 -0.4636 -0.0469 1.234 -0.9009 ...
#>   .. ..$ x2   : num [1:10] 0.74 -0.535 1.366 -0.564 -0.405 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0887 2.1499 -0.3748 -0.6259 -0.9008 ...
#>   .. ..$ x2   : num [1:10] -1.3882 -1.8286 -0.8676 -0.0422 -0.7552 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.34 -0.3194 -0.0062 -0.2289 -0.2657 ...
#>   .. ..$ x2   : num [1:10] -0.972 -0.501 1.845 -1.178 0.322 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.6465 -0.4682 -0.4636 0.0377 0.8375 ...
#>   .. ..$ x2   : num [1:10] -0.973 -0.536 -0.535 0.192 0.796 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.568 -0.901 -0.242 -0.752 -0.766 ...
#>   .. ..$ x2   : num [1:10] 2.708 -0.755 1.066 0.463 -0.386 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 2.15 -0.768 -0.752 -0.735 1.234 ...
#>   .. ..$ x2   : num [1:10] -1.829 -2.102 0.463 -0.331 -0.564 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0479 -0.0193 -0.6857 -0.5585 -0.6652 ...
#>   .. ..$ x2   : num [1:10] -0.923 -0.409 -0.982 -1.388 0.96 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.452 -0.626 0.441 -0.319 0.903 ...
#>   .. ..$ x2   : num [1:10] -0.00514 -0.0422 0.9717 -0.50119 2.4544 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (10a070aad6e63c06dbcbe210e8c6f3ac-16); on 10a070aad6e63c06dbcbe210e8c6f3ac@runnervmvrwv9<7346>]
