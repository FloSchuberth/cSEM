...
#>   ..$ imag1: int [1:250] 9 8 10 6 10 8 6 8 8 8 ...
#>   ..$ imag2: int [1:250] 10 8 10 8 9 7 7 8 4 8 ...
#>   ..$ imag3: int [1:250] 10 8 10 8 7 8 7 8 3 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 7 7 7 7 7 10 8 10 9 ...
#>   ..$ imag2: int [1:250] 6 8 7 9 7 9 0 8 9 9 ...
#>   ..$ imag3: int [1:250] 8 8 7 9 6 9 0 9 9 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 9 10 9 8 5 8 7 10 8 ...
#>   ..$ imag2: int [1:250] 8 9 10 9 7 5 8 7 10 8 ...
#>   ..$ imag3: int [1:250] 8 9 10 9 10 7 8 7 10 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.152 1.764 -1.277 0.664 0.412 ...
#>   .. ..$ x2   : num [1:10] -0.284 0.3698 -1.4722 -0.1128 -0.0186 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.901 0.596 -0.242 -0.489 -0.946 ...
#>   .. ..$ x2   : num [1:10] -0.405 0.549 0.667 0.709 0.47 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.629 -0.686 1.176 1.779 -0.735 ...
#>   .. ..$ x2   : num [1:10] -0.14 -0.982 -0.126 -1.094 -0.331 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.3748 0.16262 1.87142 0.00705 0.90251 ...
#>   .. ..$ x2   : num [1:10] -0.868 -0.576 -1.049 0.879 2.454 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.766 1.176 -0.768 -0.901 -1.595 ...
#>   .. ..$ x2   : num [1:10] -0.386 -0.126 -2.102 -0.755 -0.265 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.62 -0.714 -0.242 -1.277 -0.084 ...
#>   .. ..$ x2   : num [1:10] -1.57 0.74 1.066 -1.472 -0.708 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.18 -0.901 -0.375 -1.093 -0.279 ...
#>   .. ..$ x2   : num [1:10] 0.16 -0.405 -0.868 0.892 2.196 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.184 0.603 0.34 0.305 0.664 ...
#>   .. ..$ x2   : num [1:10] 2.375 0.449 -0.972 0.792 -0.113 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0193 1.234 -0.0479 1.1772 0.5964 ...
#>   .. ..$ x2   : num [1:10] -0.409 -0.564 -0.923 0.529 0.549 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (c3e149cf683f5b0b132c4b212232c3e7-14); on c3e149cf683f5b0b132c4b212232c3e7@runnervmlun5p<7255>]
