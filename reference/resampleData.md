...
#>   ..$ imag1: int [1:250] 10 10 7 7 9 8 8 8 8 7 ...
#>   ..$ imag2: int [1:250] 8 10 8 8 9 9 9 8 8 8 ...
#>   ..$ imag3: int [1:250] 9 8 9 8 9 9 9 9 9 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 7 7 5 8 9 8 9 7 10 ...
#>   ..$ imag2: int [1:250] 6 7 8 8 6 9 8 9 8 10 ...
#>   ..$ imag3: int [1:250] 4 7 8 8 8 9 8 10 8 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 6 9 10 5 6 8 7 8 10 ...
#>   ..$ imag2: int [1:250] 7 6 7 10 5 8 8 9 8 10 ...
#>   ..$ imag3: int [1:250] 7 5 7 8 6 7 9 9 8 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.3926 0.0377 0.6286 -0.9008 -0.6857 ...
#>   .. ..$ x2   : num [1:10] 0.499 0.192 -0.14 -0.755 -0.982 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.375 0.596 0.382 -1.093 -0.665 ...
#>   .. ..$ x2   : num [1:10] -0.868 0.549 0.538 0.892 0.96 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.5269 -0.0479 -0.7525 -0.5585 0.8375 ...
#>   .. ..$ x2   : num [1:10] -0.87 -0.923 0.463 -1.388 0.796 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.234 0.8375 0.2064 -0.0469 -1.3344 ...
#>   .. ..$ x2   : num [1:10] -0.564 0.796 1.901 1.366 -1.814 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0377 -0.3748 -0.7555 0.3003 0.452 ...
#>   .. ..$ x2   : num [1:10] 0.19244 -0.86757 0.48946 1.79714 -0.00514 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 2.15 0.34 -0.242 1.764 0.611 ...
#>   .. ..$ x2   : num [1:10] -1.829 -0.972 1.066 0.37 -1.405 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.496 -0.464 -0.62 0.34 0.79 ...
#>   .. ..$ x2   : num [1:10] 1.373 -0.535 -1.57 -0.972 1.227 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.30546 -0.90079 0.00705 -0.26574 -0.04787 ...
#>   .. ..$ x2   : num [1:10] 0.792 -0.755 0.879 0.322 -0.923 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.977 0.163 0.193 -0.783 1.646 ...
#>   .. ..$ x2   : num [1:10] 0.693 -0.576 -0.61 -0.205 -0.973 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (f07fbf5ed36d5f64de91fa1fceec494d-14); on f07fbf5ed36d5f64de91fa1fceec494d@runnervmejwal<7528>]
