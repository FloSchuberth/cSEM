...
#>   ..$ imag1: int [1:250] 5 8 10 10 9 6 8 10 10 5 ...
#>   ..$ imag2: int [1:250] 6 8 10 10 8 7 9 10 10 4 ...
#>   ..$ imag3: int [1:250] 5 8 8 9 9 7 9 10 10 4 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 6 8 8 8 8 9 5 7 ...
#>   ..$ imag2: int [1:250] 4 9 6 8 9 9 8 9 9 8 ...
#>   ..$ imag3: int [1:250] 3 5 7 8 9 10 8 10 10 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 4 8 9 10 7 9 10 9 ...
#>   ..$ imag2: int [1:250] 9 10 8 5 9 10 8 8 10 10 ...
#>   ..$ imag3: int [1:250] 9 10 8 5 6 10 8 9 10 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.2657 0.6286 0.193 1.1772 0.0749 ...
#>   .. ..$ x2   : num [1:10] 0.322 -0.14 -0.61 0.529 -0.81 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 0.1516 -2.4948 0.0845 -0.6259 ...
#>   .. ..$ x2   : num [1:10] 1.8448 -0.284 0.9231 0.7856 -0.0422 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.595 0.206 0.603 0.382 -1.334 ...
#>   .. ..$ x2   : num [1:10] -0.265 1.901 0.449 0.538 -1.814 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 0.412 0.3003 -1.5677 0.8375 ...
#>   .. ..$ x2   : num [1:10] 1.8448 -0.0186 1.7971 2.7082 0.7958 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.152 -0.773 1.779 1.646 -1.093 ...
#>   .. ..$ x2   : num [1:10] -0.284 0.536 -1.094 -0.973 0.892 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.2923 0.0749 0.34 -0.7136 0.193 ...
#>   .. ..$ x2   : num [1:10] -0.805 -0.81 -0.972 0.74 -0.61 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.2303 -0.6203 0.8539 0.0749 0.4407 ...
#>   .. ..$ x2   : num [1:10] -0.463 -1.57 -0.99 -0.81 0.972 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.779 1.1849 -0.0479 -0.5585 0.7902 ...
#>   .. ..$ x2   : num [1:10] 0.975 -0.161 -0.923 -1.388 1.227 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.334 -1.428 -0.464 0.634 1.177 ...
#>   .. ..$ x2   : num [1:10] -1.814 -0.284 -0.535 0.97 0.529 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (f85986be294a2bdbca96723d90e11c79-14); on f85986be294a2bdbca96723d90e11c79@runnervm7b5n9<7222>]
