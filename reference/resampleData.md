...
#>   ..$ imag1: int [1:250] 7 9 9 8 7 9 9 8 6 9 ...
#>   ..$ imag2: int [1:250] 9 9 9 9 7 6 10 6 8 8 ...
#>   ..$ imag3: int [1:250] 9 6 9 9 7 6 10 3 8 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 7 8 4 7 8 7 8 7 6 ...
#>   ..$ imag2: int [1:250] 7 7 6 2 7 6 7 6 7 8 ...
#>   ..$ imag3: int [1:250] 8 8 9 2 8 6 6 8 7 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 7 10 9 7 9 7 8 6 10 ...
#>   ..$ imag2: int [1:250] 6 8 10 9 10 9 7 8 6 8 ...
#>   ..$ imag3: int [1:250] 6 9 10 9 10 9 7 10 5 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.6259 0.412 0.0845 1.3974 -0.264 ...
#>   .. ..$ x2   : num [1:10] -0.0422 -0.0186 0.7856 -1.9112 -1.1964 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.646 0.596 -0.901 1.871 -0.152 ...
#>   .. ..$ x2   : num [1:10] -0.973 0.549 -0.405 -1.049 2.011 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.452 0.7902 0.4104 0.0749 -1.5955 ...
#>   .. ..$ x2   : num [1:10] -0.00514 1.22694 -1.27554 -0.81033 -0.2646 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0845 0.5269 -0.9773 -0.2793 -0.5585 ...
#>   .. ..$ x2   : num [1:10] 0.786 -0.87 0.693 2.196 -1.388 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.59643 -0.75246 -0.77298 0.15161 0.00705 ...
#>   .. ..$ x2   : num [1:10] 0.549 0.463 0.536 -0.284 0.879 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.496 -0.901 0.837 -0.779 -0.62 ...
#>   .. ..$ x2   : num [1:10] 1.373 -0.755 0.796 0.975 -1.57 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.08869 1.06643 -1.59548 -1.09341 0.00705 ...
#>   .. ..$ x2   : num [1:10] -1.388 0.897 -0.265 0.892 0.879 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.084 -1.568 1.234 0.184 0.412 ...
#>   .. ..$ x2   : num [1:10] -0.7076 2.7082 -0.5643 2.3755 -0.0186 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.664 -0.375 -0.229 1.397 -0.266 ...
#>   .. ..$ x2   : num [1:10] -0.113 -0.868 -1.178 -1.911 0.322 ...
