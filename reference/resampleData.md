...
#>   ..$ imag1: int [1:250] 8 8 5 7 9 10 8 10 8 7 ...
#>   ..$ imag2: int [1:250] 10 8 5 7 8 10 8 9 7 8 ...
#>   ..$ imag3: int [1:250] 9 8 6 7 8 10 7 9 8 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 8 6 8 6 7 8 10 8 10 ...
#>   ..$ imag2: int [1:250] 6 8 5 8 5 8 7 10 9 10 ...
#>   ..$ imag3: int [1:250] 6 10 5 8 5 8 10 10 9 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 4 10 7 9 8 8 9 10 8 8 ...
#>   ..$ imag2: int [1:250] 8 10 9 8 7 8 10 0 9 8 ...
#>   ..$ imag3: int [1:250] 8 10 8 9 7 9 9 0 9 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -1.093 -0.62 1.377 -0.773 0.452 ...
#>   .. ..$ x2   : num [1:10] 0.89249 -1.57014 1.09186 0.53592 -0.00514 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.184 0.152 -2.399 1.397 -0.229 ...
#>   .. ..$ x2   : num [1:10] 2.3755 -0.284 0.0099 -1.9112 -1.178 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.595 -1.261 1.117 1.764 0.496 ...
#>   .. ..$ x2   : num [1:10] -0.265 -1.649 -1.152 0.37 1.373 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 2.1499 0.0377 1.7637 -0.264 0.4104 ...
#>   .. ..$ x2   : num [1:10] -1.829 0.192 0.37 -1.196 -1.276 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.7525 -0.9773 0.0749 0.6637 -0.4889 ...
#>   .. ..$ x2   : num [1:10] 0.463 0.693 -0.81 -0.113 0.709 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.7902 -0.2607 -0.0062 -0.0887 -0.2303 ...
#>   .. ..$ x2   : num [1:10] 1.227 0.286 1.845 -1.388 -0.463 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.3974 0.4104 2.1499 -0.0887 0.1837 ...
#>   .. ..$ x2   : num [1:10] -1.91 -1.28 -1.83 -1.39 2.38 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.399 1.377 -0.714 0.496 -2.348 ...
#>   .. ..$ x2   : num [1:10] 0.0099 1.0919 0.7395 1.3726 -0.3413 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.665 -0.464 -0.489 -0.279 0.603 ...
#>   .. ..$ x2   : num [1:10] 0.96 -0.535 0.709 2.196 0.449 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (ed093a36ca6868cb2feb2d8508a836d4-16); on ed093a36ca6868cb2feb2d8508a836d4@runnervmrg6be<7717>]
