...
#>   ..$ imag1: int [1:250] 8 9 8 9 9 8 5 8 6 9 ...
#>   ..$ imag2: int [1:250] 9 9 8 9 9 8 7 9 8 10 ...
#>   ..$ imag3: int [1:250] 9 9 9 9 9 8 4 5 8 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 10 10 8 8 10 5 8 10 9 ...
#>   ..$ imag2: int [1:250] 5 10 10 8 8 10 5 8 10 9 ...
#>   ..$ imag3: int [1:250] 6 9 10 7 7 10 5 4 10 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 3 8 8 4 7 7 10 10 7 7 ...
#>   ..$ imag2: int [1:250] 3 9 6 2 9 8 10 10 8 7 ...
#>   ..$ imag3: int [1:250] 3 9 6 2 8 8 10 10 9 7 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -1.334 0.184 -0.18 0.611 1.234 ...
#>   .. ..$ x2   : num [1:10] -1.814 2.375 0.16 -1.405 -0.564 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6193 -0.3194 -0.4636 -0.084 0.0845 ...
#>   .. ..$ x2   : num [1:10] 0.314 -0.501 -0.535 -0.708 0.786 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.783 1.117 0.419 -1.428 1.185 ...
#>   .. ..$ x2   : num [1:10] -0.205 -1.152 0.212 -0.284 -0.161 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.852 -0.279 2.15 0.184 -0.23 ...
#>   .. ..$ x2   : num [1:10] -0.947 2.196 -1.829 2.375 -0.463 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.619 0.664 -0.229 0.441 1.185 ...
#>   .. ..$ x2   : num [1:10] 0.314 -0.113 -1.178 0.972 -0.161 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0193 0.1626 0.3003 0.9025 0.2064 ...
#>   .. ..$ x2   : num [1:10] -0.409 -0.576 1.797 2.454 1.901 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 -0.9773 1.3974 1.6465 0.3003 ...
#>   .. ..$ x2   : num [1:10] -0.81 0.693 -1.911 -0.973 1.797 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.7662 -0.7555 0.9618 0.0377 -0.6203 ...
#>   .. ..$ x2   : num [1:10] -0.3859 0.4895 -0.0325 0.1924 -1.5701 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 2.15 0.527 0.206 0.412 0.305 ...
#>   .. ..$ x2   : num [1:10] -1.8286 -0.8705 1.9009 -0.0186 0.7915 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (506c9ffe59b4b0cfd7b403c180dba0c3-13); on 506c9ffe59b4b0cfd7b403c180dba0c3@runnervm76f27<7490>]
