...
#>   ..$ imag1: int [1:250] 8 8 9 8 10 9 6 5 9 9 ...
#>   ..$ imag2: int [1:250] 10 8 9 8 10 9 6 9 9 10 ...
#>   ..$ imag3: int [1:250] 10 8 9 8 10 9 7 10 10 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 8 7 9 8 9 8 8 8 ...
#>   ..$ imag2: int [1:250] 8 8 8 7 10 8 8 8 8 7 ...
#>   ..$ imag3: int [1:250] 8 8 8 7 9 10 8 8 8 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 7 8 7 8 9 8 5 8 7 ...
#>   ..$ imag2: int [1:250] 9 9 5 5 8 9 6 8 8 8 ...
#>   ..$ imag3: int [1:250] 7 9 5 7 8 10 6 8 8 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.0193 0.1516 1.8714 -0.9008 -1.4277 ...
#>   .. ..$ x2   : num [1:10] -0.409 -0.284 -1.049 -0.755 -0.284 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.1837 0.34 -0.9456 0.5269 0.0749 ...
#>   .. ..$ x2   : num [1:10] 2.375 -0.972 0.47 -0.87 -0.81 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.093 -0.628 1.117 0.486 -0.229 ...
#>   .. ..$ x2   : num [1:10] 0.892 0.736 -1.152 -0.462 -1.178 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.397 -1.277 -0.264 0.452 -1.595 ...
#>   .. ..$ x2   : num [1:10] -1.91115 -1.47216 -1.19635 -0.00514 -0.2646 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.412 0.0377 1.1175 -0.0193 -0.084 ...
#>   .. ..$ x2   : num [1:10] -0.0186 0.1924 -1.1516 -0.4089 -0.7076 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.7902 -0.2289 0.0749 0.5269 1.6465 ...
#>   .. ..$ x2   : num [1:10] 1.227 -1.178 -0.81 -0.87 -0.973 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.664 0.837 0.34 -0.468 -0.375 ...
#>   .. ..$ x2   : num [1:10] -0.113 0.796 -0.972 -0.536 -0.868 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 -0.6857 -2.3992 -1.0934 -0.6259 ...
#>   .. ..$ x2   : num [1:10] -0.8103 -0.9819 0.0099 0.8925 -0.0422 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.177 -0.783 -0.977 1.377 0.412 ...
#>   .. ..$ x2   : num [1:10] 0.529 -0.2047 0.6931 1.0919 -0.0186 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (80134cde46b7e9c7769c6b6bfc7af4f6-17); on 80134cde46b7e9c7769c6b6bfc7af4f6@runnervm7b5n9<7149>]
