...
#>   ..$ imag1: int [1:250] 8 8 7 5 5 8 8 8 8 9 ...
#>   ..$ imag2: int [1:250] 8 8 4 5 3 8 7 8 7 8 ...
#>   ..$ imag3: int [1:250] 8 8 5 5 4 9 8 7 10 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 7 5 8 8 7 3 9 6 5 ...
#>   ..$ imag2: int [1:250] 7 9 7 9 9 8 4 9 8 6 ...
#>   ..$ imag3: int [1:250] 7 9 7 9 9 8 3 9 8 5 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 7 8 10 5 10 10 8 8 9 ...
#>   ..$ imag2: int [1:250] 8 9 8 10 8 10 10 9 7 9 ...
#>   ..$ imag3: int [1:250] 8 9 9 10 8 9 10 7 7 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.634 0.305 -0.686 -0.18 1.177 ...
#>   .. ..$ x2   : num [1:10] 0.97 0.792 -0.982 0.16 0.529 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0841 -0.0193 -0.2417 0.0749 -0.7662 ...
#>   .. ..$ x2   : num [1:10] -3.311 -0.409 1.066 -0.81 -0.386 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.489 -1.277 -1.595 0.184 0.206 ...
#>   .. ..$ x2   : num [1:10] 0.709 -1.472 -0.265 2.375 1.901 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0193 1.1762 0.7902 0.452 0.412 ...
#>   .. ..$ x2   : num [1:10] -0.40886 -0.12616 1.22694 -0.00514 -0.01863 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.34 -0.23 -0.901 -0.489 -0.977 ...
#>   .. ..$ x2   : num [1:10] -0.972 -0.463 -0.755 0.709 0.693 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.152 1.292 0.3 -1.261 -1.277 ...
#>   .. ..$ x2   : num [1:10] -0.284 -0.805 1.797 -1.649 -1.472 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.3055 -0.2657 -0.0887 1.3974 -2.3483 ...
#>   .. ..$ x2   : num [1:10] 0.792 0.322 -1.388 -1.911 -0.341 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.00705 -0.15241 0.16262 -0.23026 -0.04787 ...
#>   .. ..$ x2   : num [1:10] 0.879 2.011 -0.576 -0.463 -0.923 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.773 -0.752 -0.628 0.852 0.184 ...
#>   .. ..$ x2   : num [1:10] 0.536 0.463 0.736 -0.947 2.375 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (e36a650f7f9b891752e1b585a3aafabe-15); on e36a650f7f9b891752e1b585a3aafabe@runnervmvrwv9<7189>]
