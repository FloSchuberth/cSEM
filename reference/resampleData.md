...
#>   ..$ imag1: int [1:250] 10 10 10 8 7 7 8 7 10 3 ...
#>   ..$ imag2: int [1:250] 10 10 10 9 10 7 8 7 10 4 ...
#>   ..$ imag3: int [1:250] 8 10 10 9 10 8 8 7 8 3 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 8 10 10 8 8 8 7 10 8 ...
#>   ..$ imag2: int [1:250] 9 6 10 8 8 8 9 7 10 7 ...
#>   ..$ imag3: int [1:250] 9 6 10 8 8 3 9 7 10 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 9 9 4 8 10 5 7 7 10 ...
#>   ..$ imag2: int [1:250] 7 9 8 2 9 9 8 10 7 10 ...
#>   ..$ imag3: int [1:250] 10 7 8 2 9 9 8 10 7 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.412 -0.319 1.177 0.152 -0.18 ...
#>   .. ..$ x2   : num [1:10] -0.0186 -0.5012 0.529 -0.284 0.1602 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.714 -1.277 0.603 0.619 -1.595 ...
#>   .. ..$ x2   : num [1:10] 0.74 -1.472 0.449 0.314 -0.265 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.00705 1.11749 0.07486 0.45203 0.66373 ...
#>   .. ..$ x2   : num [1:10] 0.87936 -1.1516 -0.81033 -0.00514 -0.11277 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.626 -0.752 -0.084 0.634 -0.242 ...
#>   .. ..$ x2   : num [1:10] -0.0422 0.4627 -0.7076 0.9703 0.6667 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6286 0.4188 -0.0062 0.3821 0.0749 ...
#>   .. ..$ x2   : num [1:10] -0.14 0.212 1.845 0.538 -0.81 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.7685 1.6465 0.0377 -2.3992 0.0845 ...
#>   .. ..$ x2   : num [1:10] -2.1022 -0.9729 0.1924 0.0099 0.7856 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.901 -0.264 0.441 0.527 1.176 ...
#>   .. ..$ x2   : num [1:10] -0.405 -1.196 0.972 -0.87 -0.126 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.755 -0.773 0.496 0.206 1.234 ...
#>   .. ..$ x2   : num [1:10] 0.489 0.536 1.373 1.901 -0.564 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.468 -2.399 -0.279 1.764 -1.568 ...
#>   .. ..$ x2   : num [1:10] -0.5362 0.0099 2.196 0.3698 2.7082 ...
