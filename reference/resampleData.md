...
#>   ..$ imag1: int [1:250] 8 8 8 8 9 7 9 7 10 9 ...
#>   ..$ imag2: int [1:250] 8 9 9 6 6 8 9 7 10 6 ...
#>   ..$ imag3: int [1:250] 8 5 5 9 6 8 9 8 8 6 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 6 9 7 9 9 8 5 9 8 ...
#>   ..$ imag2: int [1:250] 8 8 10 8 9 8 9 7 10 9 ...
#>   ..$ imag3: int [1:250] 8 8 9 8 9 8 8 7 9 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 9 8 8 8 8 9 8 9 6 ...
#>   ..$ imag2: int [1:250] 9 9 8 7 8 9 9 6 9 6 ...
#>   ..$ imag3: int [1:250] 8 9 9 6 8 8 7 8 10 4 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.665 1.764 -0.559 -0.901 0.634 ...
#>   .. ..$ x2   : num [1:10] 0.96 0.37 -1.388 -0.405 0.97 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.1837 -0.7525 1.1849 0.412 -0.0062 ...
#>   .. ..$ x2   : num [1:10] 2.3755 0.4627 -0.1608 -0.0186 1.8448 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.768 0.962 0.34 -0.393 -0.735 ...
#>   .. ..$ x2   : num [1:10] -2.1022 -0.0325 -0.972 0.4993 -0.3313 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0193 -0.6203 -2.3483 -0.0887 1.1849 ...
#>   .. ..$ x2   : num [1:10] -0.409 -1.57 -0.341 -1.388 -0.161 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.193 -0.946 0.603 -0.393 -1.568 ...
#>   .. ..$ x2   : num [1:10] -0.61 0.47 0.449 0.499 2.708 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.266 -0.319 0.206 -0.242 -2.399 ...
#>   .. ..$ x2   : num [1:10] 0.322 -0.5012 1.9009 0.6667 0.0099 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.837 -0.62 0.903 0.854 0.34 ...
#>   .. ..$ x2   : num [1:10] 0.796 -1.57 2.454 -0.99 -0.972 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.901 -0.755 0.486 -0.084 -0.901 ...
#>   .. ..$ x2   : num [1:10] -0.755 0.489 -0.462 -0.708 -0.405 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.375 -0.152 0.603 1.779 0.619 ...
#>   .. ..$ x2   : num [1:10] -0.868 2.011 0.449 -1.094 0.314 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (ad3007ae7907c56709b446282730b348-25); on ad3007ae7907c56709b446282730b348@runnervmvrwv9<7229>]
