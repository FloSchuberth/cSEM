...
#>   ..$ imag1: int [1:250] 7 8 9 8 8 6 7 7 8 7 ...
#>   ..$ imag2: int [1:250] 7 4 9 8 8 6 7 9 5 7 ...
#>   ..$ imag3: int [1:250] 7 3 9 9 8 6 8 9 9 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 9 4 8 5 8 8 8 8 6 ...
#>   ..$ imag2: int [1:250] 8 9 1 8 5 9 7 8 8 8 ...
#>   ..$ imag3: int [1:250] 8 9 4 4 5 9 8 9 8 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 9 10 8 10 8 8 10 8 9 ...
#>   ..$ imag2: int [1:250] 9 9 10 7 10 9 9 10 8 9 ...
#>   ..$ imag3: int [1:250] 9 7 10 6 10 9 9 10 8 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.603 -0.768 2.15 0.794 -0.23 ...
#>   .. ..$ x2   : num [1:10] 0.449 -2.102 -1.829 0.362 -0.463 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.193 -0.229 0.611 0.41 -0.686 ...
#>   .. ..$ x2   : num [1:10] -0.61 -1.178 -1.405 -1.276 -0.982 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6637 0.0377 1.6465 -0.9773 1.234 ...
#>   .. ..$ x2   : num [1:10] -0.113 0.192 -0.973 0.693 -0.564 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.41 0.486 1.764 0.441 -0.559 ...
#>   .. ..$ x2   : num [1:10] -1.276 -0.462 0.37 0.972 -1.388 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.264 0.452 -0.62 -1.277 -0.901 ...
#>   .. ..$ x2   : num [1:10] -1.19635 -0.00514 -1.57014 -1.47216 -0.40481 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.084 1.3766 1.234 -1.5955 -0.0193 ...
#>   .. ..$ x2   : num [1:10] -0.708 1.092 -0.564 -0.265 -0.409 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 -0.779 -0.7555 1.3974 -0.3748 ...
#>   .. ..$ x2   : num [1:10] -0.81 0.975 0.489 -1.911 -0.868 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.428 -0.468 -1.261 -0.626 0.854 ...
#>   .. ..$ x2   : num [1:10] -0.2837 -0.5362 -1.6493 -0.0422 -0.9897 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.242 -0.773 -0.714 -0.768 0.452 ...
#>   .. ..$ x2   : num [1:10] 1.06643 0.53592 0.73952 -2.10225 -0.00514 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (05d5b9aa6f7eccfe434d9d57ea28c8b5-18); on 05d5b9aa6f7eccfe434d9d57ea28c8b5@runnervmvrwv9<7332>]
