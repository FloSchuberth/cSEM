...
#>   ..$ imag1: int [1:250] 4 8 8 7 10 9 8 8 8 9 ...
#>   ..$ imag2: int [1:250] 5 9 8 10 10 9 6 7 8 9 ...
#>   ..$ imag3: int [1:250] 5 9 8 10 10 7 9 7 8 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 5 6 7 9 8 9 10 9 3 ...
#>   ..$ imag2: int [1:250] 7 5 8 8 9 8 6 10 9 3 ...
#>   ..$ imag3: int [1:250] 10 5 8 8 9 8 6 10 10 3 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 6 8 6 7 7 9 6 6 10 7 ...
#>   ..$ imag2: int [1:250] 6 9 8 7 8 10 7 8 10 7 ...
#>   ..$ imag3: int [1:250] 4 9 7 8 8 10 7 7 10 7 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -1.595 0.79 -2.399 0.412 0.596 ...
#>   .. ..$ x2   : num [1:10] -0.2646 1.2269 0.0099 -0.0186 0.5492 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.9773 2.1499 -0.1524 -0.0841 -2.4948 ...
#>   .. ..$ x2   : num [1:10] 0.693 -1.829 2.011 -3.311 0.923 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.871 1.397 0.852 -2.348 0.206 ...
#>   .. ..$ x2   : num [1:10] -1.049 -1.911 -0.947 -0.341 1.901 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0469 -0.7662 -0.084 -0.9008 -0.3926 ...
#>   .. ..$ x2   : num [1:10] 1.366 -0.386 -0.708 -0.755 0.499 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.319 0.452 -0.626 -2.495 -0.735 ...
#>   .. ..$ x2   : num [1:10] -0.50119 -0.00514 -0.0422 0.92313 -0.33128 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.42769 0.62857 -0.2289 0.00705 1.29231 ...
#>   .. ..$ x2   : num [1:10] -0.284 -0.14 -1.178 0.879 -0.805 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.7525 0.34 1.6465 -0.2657 -0.0841 ...
#>   .. ..$ x2   : num [1:10] 0.463 -0.972 -0.973 0.322 -3.311 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.595 0.837 0.163 0.619 1.185 ...
#>   .. ..$ x2   : num [1:10] -0.265 0.796 -0.576 0.314 -0.161 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.00705 0.85171 1.17622 1.39743 -0.26399 ...
#>   .. ..$ x2   : num [1:10] 0.879 -0.947 -0.126 -1.911 -1.196 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (d3a15af49607af1caece1d96f72cee0f-16); on d3a15af49607af1caece1d96f72cee0f@runnervmvrwv9<7235>]
