...
#>   ..$ imag1: int [1:250] 8 7 10 6 7 8 9 8 8 8 ...
#>   ..$ imag2: int [1:250] 7 9 10 8 7 9 9 10 8 9 ...
#>   ..$ imag3: int [1:250] 7 9 10 8 7 9 9 10 8 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 0 8 7 9 10 10 8 8 9 6 ...
#>   ..$ imag2: int [1:250] 4 9 5 10 10 10 8 8 5 7 ...
#>   ..$ imag3: int [1:250] 7 9 7 10 10 10 8 8 6 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 4 7 7 8 8 8 10 10 10 9 ...
#>   ..$ imag2: int [1:250] 6 9 9 9 8 7 10 10 10 9 ...
#>   ..$ imag3: int [1:250] 5 9 8 7 8 8 10 10 10 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.0377 -0.773 0.6029 -0.9008 0.4407 ...
#>   .. ..$ x2   : num [1:10] 0.192 0.536 0.449 -0.755 0.972 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.4188 0.6286 1.2923 -0.3926 -0.0479 ...
#>   .. ..$ x2   : num [1:10] 0.212 -0.14 -0.805 0.499 -0.923 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.1837 0.0749 -0.7662 2.1499 0.2064 ...
#>   .. ..$ x2   : num [1:10] 2.375 -0.81 -0.386 -1.829 1.901 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.3055 -0.9009 -0.2657 -0.0469 0.7936 ...
#>   .. ..$ x2   : num [1:10] 0.792 -0.405 0.322 1.366 0.362 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.229 0.527 -1.428 -0.766 -0.319 ...
#>   .. ..$ x2   : num [1:10] -1.178 -0.87 -0.284 -0.386 -0.501 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.4104 1.3974 0.4856 0.0377 -0.7136 ...
#>   .. ..$ x2   : num [1:10] -1.276 -1.911 -0.462 0.192 0.74 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.377 -0.665 0.837 0.611 -0.773 ...
#>   .. ..$ x2   : num [1:10] 1.092 0.96 0.796 -1.405 0.536 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 -1.4277 -0.2417 0.4959 1.1772 ...
#>   .. ..$ x2   : num [1:10] -0.81 -0.284 1.066 1.373 0.529 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0469 1.1762 0.1626 -1.5677 0.9025 ...
#>   .. ..$ x2   : num [1:10] 1.366 -0.126 -0.576 2.708 2.454 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (4a488744f73c2a2f5d10afd933dfeb27-17); on 4a488744f73c2a2f5d10afd933dfeb27@runnervm7b5n9<7204>]
