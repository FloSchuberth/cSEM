...
#>   ..$ imag1: int [1:250] 8 9 6 5 8 6 10 10 8 10 ...
#>   ..$ imag2: int [1:250] 8 9 8 5 10 7 10 10 8 10 ...
#>   ..$ imag3: int [1:250] 8 9 7 6 10 7 8 10 8 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 9 8 8 10 6 6 10 9 8 ...
#>   ..$ imag2: int [1:250] 10 10 6 6 10 8 8 10 9 7 ...
#>   ..$ imag3: int [1:250] 10 10 9 6 10 8 8 10 9 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 3 8 7 10 9 9 8 6 5 8 ...
#>   ..$ imag2: int [1:250] 3 8 9 10 9 9 6 7 9 8 ...
#>   ..$ imag3: int [1:250] 3 8 9 10 9 7 9 7 10 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.486 0.603 -0.628 0.854 0.629 ...
#>   .. ..$ x2   : num [1:10] -0.462 0.449 0.736 -0.99 -0.14 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.206 -0.901 1.646 0.903 -0.229 ...
#>   .. ..$ x2   : num [1:10] 1.901 -0.405 -0.973 2.454 -1.178 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.377 -0.665 0.527 1.779 -1.093 ...
#>   .. ..$ x2   : num [1:10] 1.092 0.96 -0.87 -1.094 0.892 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.084 0.79 -0.393 0.184 1.377 ...
#>   .. ..$ x2   : num [1:10] -0.708 1.227 0.499 2.375 1.092 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 -0.766 0.452 0.634 0.486 ...
#>   .. ..$ x2   : num [1:10] -0.33128 -0.38586 -0.00514 0.97031 -0.46229 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.18 0.903 0.305 0.34 -0.755 ...
#>   .. ..$ x2   : num [1:10] 0.16 2.454 0.792 -0.972 0.489 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0062 1.234 1.1175 2.1499 -0.9008 ...
#>   .. ..$ x2   : num [1:10] 1.845 -0.564 -1.152 -1.829 -0.755 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.193 -0.393 0.527 -0.779 -0.766 ...
#>   .. ..$ x2   : num [1:10] -0.61 0.499 -0.87 0.975 -0.386 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.634 0.596 -0.977 -0.23 0.412 ...
#>   .. ..$ x2   : num [1:10] 0.9703 0.5492 0.6931 -0.4629 -0.0186 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (93a75fbd4cba56ab4e5dfc75aca0b314-14); on 93a75fbd4cba56ab4e5dfc75aca0b314@runnervm76f27<7234>]
