...
#>   ..$ imag1: int [1:250] 9 7 8 7 6 9 10 8 8 8 ...
#>   ..$ imag2: int [1:250] 8 7 7 8 7 10 9 8 8 9 ...
#>   ..$ imag3: int [1:250] 9 8 7 8 7 8 9 8 8 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 6 8 9 8 7 10 8 8 9 ...
#>   ..$ imag2: int [1:250] 6 5 9 9 7 8 10 8 9 9 ...
#>   ..$ imag3: int [1:250] 6 5 9 9 8 7 10 8 5 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 10 8 6 9 7 7 9 4 8 9 ...
#>   ..$ imag2: int [1:250] 10 8 8 10 7 7 8 8 5 10 ...
#>   ..$ imag3: int [1:250] 10 8 7 10 8 7 8 8 7 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.628 1.7637 -0.0469 0.3003 -0.2657 ...
#>   .. ..$ x2   : num [1:10] 0.736 0.37 1.366 1.797 0.322 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.229 1.871 -1.261 0.152 0.837 ...
#>   .. ..$ x2   : num [1:10] -1.178 -1.049 -1.649 -0.284 0.796 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.393 -1.277 1.177 -0.686 -1.093 ...
#>   .. ..$ x2   : num [1:10] 0.499 -1.472 0.529 -0.982 0.892 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.794 -0.62 -0.319 -0.468 1.779 ...
#>   .. ..$ x2   : num [1:10] 0.362 -1.57 -0.501 -0.536 -1.094 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0377 -0.7555 1.1849 1.8714 -0.242 ...
#>   .. ..$ x2   : num [1:10] 0.192 0.489 -0.161 -1.049 0.667 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.1524 -0.1804 0.6344 0.0845 0.1837 ...
#>   .. ..$ x2   : num [1:10] 2.011 0.16 0.97 0.786 2.375 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.266 -0.264 -1.261 1.176 1.397 ...
#>   .. ..$ x2   : num [1:10] 0.322 -1.196 -1.649 -0.126 -1.911 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6029 0.34 0.0377 0.4959 -0.3194 ...
#>   .. ..$ x2   : num [1:10] 0.449 -0.972 0.192 1.373 -0.501 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.0841 2.1499 0.3003 -0.6259 1.8714 ...
#>   .. ..$ x2   : num [1:10] -3.3107 -1.8286 1.7971 -0.0422 -1.049 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (db786ef7d63d03af1f1a8eea14909d4a-20); on db786ef7d63d03af1f1a8eea14909d4a@runnervm7b5n9<7260>]
