...
#>   ..$ imag1: int [1:250] 8 10 4 6 4 5 10 8 4 8 ...
#>   ..$ imag2: int [1:250] 7 10 2 7 6 5 0 9 1 7 ...
#>   ..$ imag3: int [1:250] 8 10 2 7 5 7 0 9 4 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 10 8 10 6 8 9 10 10 ...
#>   ..$ imag2: int [1:250] 8 8 10 8 10 6 8 10 9 10 ...
#>   ..$ imag3: int [1:250] 8 9 9 8 10 6 7 9 7 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 9 9 7 10 8 8 7 10 4 ...
#>   ..$ imag2: int [1:250] 8 8 8 8 10 8 8 7 10 5 ...
#>   ..$ imag3: int [1:250] 8 9 8 8 8 8 9 7 10 5 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.264 -0.489 0.452 -0.686 -0.23 ...
#>   .. ..$ x2   : num [1:10] -1.19635 0.70895 -0.00514 -0.98192 -0.46288 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.5269 -0.2289 0.193 -0.3748 -0.0479 ...
#>   .. ..$ x2   : num [1:10] -0.87 -1.178 -0.61 -0.868 -0.923 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.084 1.377 0.3 -0.735 -0.279 ...
#>   .. ..$ x2   : num [1:10] -0.708 1.092 1.797 -0.331 2.196 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.1804 -0.6203 -0.084 0.5269 0.0845 ...
#>   .. ..$ x2   : num [1:10] 0.16 -1.57 -0.708 -0.87 0.786 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.611 -0.901 -2.348 0.419 0.837 ...
#>   .. ..$ x2   : num [1:10] -1.405 -0.405 -0.341 0.212 0.796 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.794 -0.714 -1.428 1.377 -0.686 ...
#>   .. ..$ x2   : num [1:10] 0.362 0.74 -0.284 1.092 -0.982 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.783 -0.628 0.852 -0.766 0.193 ...
#>   .. ..$ x2   : num [1:10] -0.205 0.736 -0.947 -0.386 -0.61 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.093 -0.264 -0.261 -1.261 2.15 ...
#>   .. ..$ x2   : num [1:10] 0.892 -1.196 0.286 -1.649 -1.829 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.619 -1.595 0.419 -1.428 0.837 ...
#>   .. ..$ x2   : num [1:10] 0.314 -0.265 0.212 -0.284 0.796 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (1fe9b9676169b22243c17199a03a2afd-19); on 1fe9b9676169b22243c17199a03a2afd@runnervm7b5n9<7272>]
