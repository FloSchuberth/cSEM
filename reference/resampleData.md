...
#>   ..$ imag1: int [1:250] 9 10 8 6 6 8 5 6 3 7 ...
#>   ..$ imag2: int [1:250] 9 8 7 5 8 7 5 5 4 7 ...
#>   ..$ imag3: int [1:250] 10 8 6 5 8 8 6 5 3 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 8 9 8 9 10 8 10 6 10 ...
#>   ..$ imag2: int [1:250] 9 8 9 9 9 10 7 10 6 10 ...
#>   ..$ imag3: int [1:250] 10 8 9 9 10 10 10 10 7 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 6 6 8 7 9 8 10 8 9 ...
#>   ..$ imag2: int [1:250] 9 8 7 8 10 10 8 10 6 9 ...
#>   ..$ imag3: int [1:250] 7 8 7 8 10 9 8 10 6 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.4636 1.1175 0.0377 0.0845 -0.0062 ...
#>   .. ..$ x2   : num [1:10] -0.535 -1.152 0.192 0.786 1.845 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.779 0.419 -0.18 -0.242 -1.568 ...
#>   .. ..$ x2   : num [1:10] -1.094 0.212 0.16 1.066 2.708 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.397 -0.264 2.15 0.382 0.206 ...
#>   .. ..$ x2   : num [1:10] -1.911 -1.196 -1.829 0.538 1.901 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.901 1.185 -0.783 0.184 1.377 ...
#>   .. ..$ x2   : num [1:10] -0.405 -0.161 -0.205 2.375 1.092 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.837 -0.489 -0.23 2.15 1.871 ...
#>   .. ..$ x2   : num [1:10] 0.796 0.709 -0.463 -1.829 -1.049 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.441 0.152 -1.277 0.854 -1.428 ...
#>   .. ..$ x2   : num [1:10] 0.972 -0.284 -1.472 -0.99 -0.284 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.4948 0.34 -0.242 1.6465 -0.0062 ...
#>   .. ..$ x2   : num [1:10] 0.923 -0.972 0.667 -0.973 1.845 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.1516 0.6286 0.0377 -0.084 1.234 ...
#>   .. ..$ x2   : num [1:10] -0.284 -0.14 0.192 -0.708 -0.564 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.348 -0.152 0.412 -0.468 0.619 ...
#>   .. ..$ x2   : num [1:10] -0.3413 2.0113 -0.0186 -0.5362 0.3142 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (b07de3088f044f018949d32fe3196639-14); on b07de3088f044f018949d32fe3196639@runnervmvrwv9<7152>]
