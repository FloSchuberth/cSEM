...
#>   ..$ imag1: int [1:250] 10 10 4 6 7 10 10 9 8 9 ...
#>   ..$ imag2: int [1:250] 10 10 6 7 8 10 10 8 8 9 ...
#>   ..$ imag3: int [1:250] 10 8 9 7 8 10 10 8 9 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 7 8 7 7 9 9 7 9 10 ...
#>   ..$ imag2: int [1:250] 5 4 7 8 9 9 9 8 10 3 ...
#>   ..$ imag3: int [1:250] 7 5 7 8 9 9 9 7 9 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 7 8 8 8 7 9 8 10 7 8 ...
#>   ..$ imag2: int [1:250] 7 9 8 5 4 10 7 10 8 8 ...
#>   ..$ imag3: int [1:250] 8 10 8 5 5 8 6 10 8 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.628 -0.559 0.452 -0.946 -2.399 ...
#>   .. ..$ x2   : num [1:10] 0.73619 -1.38843 -0.00514 0.4699 0.0099 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.0749 0.6029 -0.0887 -0.9008 0.7936 ...
#>   .. ..$ x2   : num [1:10] -0.81 0.449 -1.388 -0.755 0.362 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.854 -0.18 -0.773 1.176 -1.595 ...
#>   .. ..$ x2   : num [1:10] -0.99 0.16 0.536 -0.126 -0.265 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.2289 -0.0841 0.8539 -0.9008 -0.1804 ...
#>   .. ..$ x2   : num [1:10] -1.178 -3.311 -0.99 -0.755 0.16 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.334 -0.084 1.377 -0.773 -1.568 ...
#>   .. ..$ x2   : num [1:10] -1.814 -0.708 1.092 0.536 2.708 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.3974 -0.4682 -0.7136 -0.0062 0.0377 ...
#>   .. ..$ x2   : num [1:10] -1.911 -0.536 0.74 1.845 0.192 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.399 0.382 -0.901 -1.334 0.441 ...
#>   .. ..$ x2   : num [1:10] 0.0099 0.5385 -0.7552 -1.8135 0.9717 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 2.1499 -0.0887 1.7637 -1.2775 0.34 ...
#>   .. ..$ x2   : num [1:10] -1.829 -1.388 0.37 -1.472 -0.972 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.305 0.854 1.234 -1.261 0.496 ...
#>   .. ..$ x2   : num [1:10] 0.792 -0.99 -0.564 -1.649 1.373 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (19639a1599574824a979732cf3901258-19); on 19639a1599574824a979732cf3901258@runnervm7b5n9<7238>]
