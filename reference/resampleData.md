...
#>   ..$ imag1: int [1:250] 9 9 7 3 8 8 4 9 7 8 ...
#>   ..$ imag2: int [1:250] 9 10 8 4 8 7 6 9 7 8 ...
#>   ..$ imag3: int [1:250] 9 10 8 3 8 7 5 10 8 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 10 6 10 9 5 10 7 5 3 ...
#>   ..$ imag2: int [1:250] 9 10 6 10 7 7 10 8 4 3 ...
#>   ..$ imag3: int [1:250] 9 10 5 10 7 4 10 8 4 3 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 8 9 10 7 9 8 9 6 9 ...
#>   ..$ imag2: int [1:250] 5 9 10 10 7 10 9 9 7 9 ...
#>   ..$ imag3: int [1:250] 7 9 7 10 7 9 9 10 7 9 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.783 -0.768 -1.093 0.611 0.34 ...
#>   .. ..$ x2   : num [1:10] -0.205 -2.102 0.892 -1.405 -0.972 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.18 -0.229 0.41 0.619 -0.773 ...
#>   .. ..$ x2   : num [1:10] 0.16 -1.178 -1.276 0.314 0.536 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.334 -2.495 -0.714 0.852 0.527 ...
#>   .. ..$ x2   : num [1:10] -1.814 0.923 0.74 -0.947 -0.87 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.87142 1.76365 -1.09341 0.00705 -1.33435 ...
#>   .. ..$ x2   : num [1:10] -1.049 0.37 0.892 0.879 -1.814 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.229 -2.495 -0.735 -0.266 0.3 ...
#>   .. ..$ x2   : num [1:10] -1.178 0.923 -0.331 0.322 1.797 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.1762 -0.0193 0.0377 -0.9009 -0.0062 ...
#>   .. ..$ x2   : num [1:10] -0.126 -0.409 0.192 -0.405 1.845 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.61097 0.49587 0.52686 -0.62795 0.00705 ...
#>   .. ..$ x2   : num [1:10] -1.405 1.373 -0.87 0.736 0.879 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.234 0.3003 -0.6857 -0.0469 -0.2607 ...
#>   .. ..$ x2   : num [1:10] -0.564 1.797 -0.982 1.366 0.286 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.901 -0.62 0.852 -0.766 -0.714 ...
#>   .. ..$ x2   : num [1:10] -0.405 -1.57 -0.947 -0.386 0.74 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (563eeb85ad893344ab940c405675d4e7-17); on 563eeb85ad893344ab940c405675d4e7@runnervmkkn4f<7278>]
