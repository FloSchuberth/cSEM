...
#>   ..$ imag1: int [1:250] 3 7 10 10 7 9 8 5 8 8 ...
#>   ..$ imag2: int [1:250] 3 7 10 10 6 7 6 6 8 7 ...
#>   ..$ imag3: int [1:250] 3 7 10 10 9 8 9 5 8 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 4 8 9 6 9 0 10 6 6 ...
#>   ..$ imag2: int [1:250] 9 2 6 9 6 10 4 10 7 7 ...
#>   ..$ imag3: int [1:250] 9 2 9 9 7 9 7 10 7 7 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 6 4 6 10 8 10 0 10 9 ...
#>   ..$ imag2: int [1:250] 8 6 5 6 10 6 10 4 0 9 ...
#>   ..$ imag3: int [1:250] 8 4 5 7 10 6 10 7 0 10 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 1.185 -0.559 1.177 1.779 -1.334 ...
#>   .. ..$ x2   : num [1:10] -0.161 -1.388 0.529 -1.094 -1.814 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 2.1499 0.1837 -0.0887 -0.9008 0.0377 ...
#>   .. ..$ x2   : num [1:10] -1.829 2.375 -1.388 -0.755 0.192 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.18 -1.568 0.79 0.664 -0.714 ...
#>   .. ..$ x2   : num [1:10] 0.16 2.708 1.227 -0.113 0.74 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.755 0.441 1.117 0.837 0.152 ...
#>   .. ..$ x2   : num [1:10] 0.489 0.972 -1.152 0.796 -0.284 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.486 -1.277 -0.62 -0.18 -1.568 ...
#>   .. ..$ x2   : num [1:10] -0.462 -1.472 -1.57 0.16 2.708 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.686 0.79 1.646 -0.752 -0.264 ...
#>   .. ..$ x2   : num [1:10] -0.982 1.227 -0.973 0.463 -1.196 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.977 0.41 -0.946 0.382 0.79 ...
#>   .. ..$ x2   : num [1:10] 0.693 -1.276 0.47 0.538 1.227 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.5955 -0.773 -0.0193 1.6465 0.5964 ...
#>   .. ..$ x2   : num [1:10] -0.265 0.536 -0.409 -0.973 0.549 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.4407 0.0845 -0.0062 -0.4636 -0.2417 ...
#>   .. ..$ x2   : num [1:10] 0.972 0.786 1.845 -0.535 1.066 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (a551fef3fa118466148acf25931cc1cd-16); on a551fef3fa118466148acf25931cc1cd@runnervmlun5p<7247>]
