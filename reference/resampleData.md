...
#>   ..$ imag1: int [1:250] 9 10 8 8 8 9 8 10 7 8 ...
#>   ..$ imag2: int [1:250] 9 10 8 7 9 9 8 10 8 7 ...
#>   ..$ imag3: int [1:250] 10 8 8 8 9 9 9 10 9 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 8 9 9 9 8 8 9 4 ...
#>   ..$ imag2: int [1:250] 9 7 8 5 10 10 7 9 10 6 ...
#>   ..$ imag3: int [1:250] 7 7 8 7 10 10 6 9 7 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 9 6 7 6 6 8 5 8 8 ...
#>   ..$ imag2: int [1:250] 8 9 7 7 8 5 9 4 8 8 ...
#>   ..$ imag3: int [1:250] 8 9 7 8 8 5 5 4 9 3 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] -0.266 0.903 -0.468 1.764 -1.261 ...
#>   .. ..$ x2   : num [1:10] 0.322 2.454 -0.536 0.37 -1.649 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.8714 0.0377 -0.1524 -0.2417 0.412 ...
#>   .. ..$ x2   : num [1:10] -1.049 0.1924 2.0113 1.0664 -0.0186 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.2303 1.1849 0.8539 0.4856 0.0749 ...
#>   .. ..$ x2   : num [1:10] -0.463 -0.161 -0.99 -0.462 -0.81 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.5585 1.234 -0.6652 -1.4277 0.0845 ...
#>   .. ..$ x2   : num [1:10] -1.388 -0.564 0.96 -0.284 0.786 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.664 0.629 1.764 -0.977 0.193 ...
#>   .. ..$ x2   : num [1:10] -0.113 -0.14 0.37 0.693 -0.61 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.23 1.871 0.206 0.611 -0.779 ...
#>   .. ..$ x2   : num [1:10] -0.463 -1.049 1.901 -1.405 0.975 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.193 0.527 -0.768 1.779 -0.464 ...
#>   .. ..$ x2   : num [1:10] -0.61 -0.87 -2.102 -1.094 -0.535 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.6203 0.9025 -1.5677 -0.0469 0.6193 ...
#>   .. ..$ x2   : num [1:10] -1.57 2.454 2.708 1.366 0.314 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.084 0.206 0.163 -1.261 -0.229 ...
#>   .. ..$ x2   : num [1:10] -0.708 1.901 -0.576 -1.649 -1.178 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (5809bafd52ec90ca8d721e63737e44b6-15); on 5809bafd52ec90ca8d721e63737e44b6@runnervmvrwv9<7184>]
