...
#>   ..$ imag1: int [1:250] 10 6 8 6 8 8 9 7 6 6 ...
#>   ..$ imag2: int [1:250] 3 5 8 8 4 8 9 8 7 6 ...
#>   ..$ imag3: int [1:250] 7 5 8 7 6 8 9 7 7 6 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 6 10 8 9 7 10 9 9 8 ...
#>   ..$ imag2: int [1:250] 7 5 3 8 9 7 10 10 9 8 ...
#>   ..$ imag3: int [1:250] 7 5 7 8 9 7 10 10 10 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 8 8 7 9 8 7 7 8 9 ...
#>   ..$ imag2: int [1:250] 8 8 7 7 9 8 7 9 10 10 ...
#>   ..$ imag3: int [1:250] 8 8 7 6 10 8 8 9 10 7 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 2.15 1.117 -0.261 -0.628 -0.464 ...
#>   .. ..$ x2   : num [1:10] -1.829 -1.152 0.286 0.736 -0.535 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.946 1.185 0.3 -0.084 -0.152 ...
#>   .. ..$ x2   : num [1:10] 0.47 -0.161 1.797 -0.708 2.011 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.794 0.837 0.903 1.292 1.377 ...
#>   .. ..$ x2   : num [1:10] 0.362 0.796 2.454 -0.805 1.092 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.634 0.152 -0.319 -0.946 -0.264 ...
#>   .. ..$ x2   : num [1:10] 0.97 -0.284 -0.501 0.47 -1.196 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -2.495 -1.334 -0.714 0.603 -0.084 ...
#>   .. ..$ x2   : num [1:10] 0.923 -1.814 0.74 0.449 -0.708 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.6286 -0.0193 -1.2613 -0.4636 -0.242 ...
#>   .. ..$ x2   : num [1:10] -0.14 -0.409 -1.649 -0.535 0.667 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.242 -0.084 -0.773 -0.152 0.163 ...
#>   .. ..$ x2   : num [1:10] 0.667 -0.708 0.536 2.011 -0.576 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.5269 -0.0841 0.4407 -0.7525 0.3055 ...
#>   .. ..$ x2   : num [1:10] -0.87 -3.311 0.972 0.463 0.792 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.3974 0.0845 0.4959 1.1762 -0.264 ...
#>   .. ..$ x2   : num [1:10] -1.911 0.786 1.373 -0.126 -1.196 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (59650f9833f4b1cd6459d4f7bb4ef574-12); on 59650f9833f4b1cd6459d4f7bb4ef574@runnervmvrwv9<7105>]
