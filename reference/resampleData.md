...
#>   ..$ imag1: int [1:250] 9 10 10 8 7 5 8 10 9 9 ...
#>   ..$ imag2: int [1:250] 9 10 10 8 8 9 8 10 9 9 ...
#>   ..$ imag3: int [1:250] 9 10 10 8 9 10 9 10 9 9 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 2 8 7 7 9 9 6 10 7 ...
#>   ..$ imag2: int [1:250] 9 2 7 8 7 9 10 8 10 7 ...
#>   ..$ imag3: int [1:250] 9 8 8 8 8 7 9 8 8 5 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 8 6 7 8 9 8 8 9 6 8 ...
#>   ..$ imag2: int [1:250] 8 6 5 7 10 8 6 8 8 9 ...
#>   ..$ imag3: int [1:250] 8 5 7 7 9 9 7 8 8 8 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 2.14992 0.00705 1.77874 0.44069 0.49587 ...
#>   .. ..$ x2   : num [1:10] -1.829 0.879 -1.094 0.972 1.373 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.854 0.527 0.452 0.664 -0.946 ...
#>   .. ..$ x2   : num [1:10] -0.98968 -0.87046 -0.00514 -0.11277 0.4699 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.177 1.292 0.305 0.962 0.419 ...
#>   .. ..$ x2   : num [1:10] 0.529 -0.8047 0.7915 -0.0325 0.2118 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.177 -0.084 -0.18 1.185 0.611 ...
#>   .. ..$ x2   : num [1:10] 0.529 -0.708 0.16 -0.161 -1.405 ...
#>   .. ..$ group: chr [1:10] "male" "female" "female" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.486 0.3 1.397 -2.399 -0.279 ...
#>   .. ..$ x2   : num [1:10] -0.4623 1.7971 -1.9112 0.0099 2.196 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.664 -0.628 -0.23 -0.261 0.163 ...
#>   .. ..$ x2   : num [1:10] -0.113 0.736 -0.463 0.286 -0.576 ...
#>   .. ..$ group: chr [1:10] "male" "male" "female" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.382 0.163 0.854 -0.242 1.779 ...
#>   .. ..$ x2   : num [1:10] 0.538 -0.576 -0.99 1.066 -1.094 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.626 1.234 0.619 0.206 0.603 ...
#>   .. ..$ x2   : num [1:10] -0.0422 -0.5643 0.3142 1.9009 0.4491 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.783 -1.093 -0.779 -0.468 1.176 ...
#>   .. ..$ x2   : num [1:10] -0.205 0.892 0.975 -0.536 -0.126 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (e0eb5cf36935d4d830d1ef030e0e03a5-15); on e0eb5cf36935d4d830d1ef030e0e03a5@runnervmrg6be<8010>]
