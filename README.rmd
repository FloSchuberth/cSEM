...
[![Build Status](https://travis-ci.org/M-E-Rademaker/cSEM.svg?branch=master)](https://travis-ci.org/M-E-Rademaker/cSEM)
...
- "User-centered" mainly boils down to: `cSEM` is easy, i.e. intuitive to use by non-R experts! 
...
A usefule tool to examine a list is the [listviewer package](https://github.com/timelyportfolio/listviewer). 
