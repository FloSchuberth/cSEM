...
techniques such as partial least squares path modelling (PLS) and its consistent 
version PLSc, generalized structured component analysis (GSCA), generalized structured component 
analyis with uniqueness terms (GSCAm), unit weights (sum score) and
