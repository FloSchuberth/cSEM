...
WARNING: THIS IS WORK IN PROGRESS. BREAKING CHANGES TO THE API ARE VERY LIKELY. 
         Use the package with caution and please report bugs to [the package developer](mailto:manuel.rademaker@uni-wuerzburg.de). 
...
- `assess()` : assess the model using common fit and assessment measures
...
- `testHausman()` : performs the regression-based Hausam test to test for endogeneity.
