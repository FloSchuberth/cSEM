...
- Adjust p-value calculation in testMGD in case of permutation-based tests to prevent that p-values   can be exactly 0. Thanks to Michael
  
- Fix bug in BasicCIResample(). Thanks to Michael Truong.

- Implementation of doModelSearch() to perform AGAS-PLS. Thanks to Gloria Pietropolli.
