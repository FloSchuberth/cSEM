...
analyis with uniqueness terms (GSCAm), generalized canonical correlation analysis (GCCA),
...
or `cSEMResults_2ndorder`) however users usually dont need to work since postestimation
function automatically (will eventually) work on all classes. 
