...
- bug fix in the calculateAVE() and calculateRho() functions. Now results are reported for models containing more than one second-order construct. Thanks Jean-Baptiste.
