...
#
# - AVE (average variance extracted). Method: default; multi
# - CR (composite reliability). Method: default; multi
# - Cronbach alpha incl. CI. Method: default; multi
# - Fornell_Larcker. Function
# - effect size. Method: default; multi
# - GoF. Method: default; multi
# - VIFPLS. Method: default; multi

# - Quasi empirical bayes
# - REBUS
